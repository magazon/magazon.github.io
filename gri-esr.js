...
/** @constructor */
ScalaJS.c.Lcom_grisoft_panels_ElementsUtils$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.Lcom_grisoft_panels_ElementsUtils$.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_panels_ElementsUtils$.prototype.constructor = ScalaJS.c.Lcom_grisoft_panels_ElementsUtils$;
/** @constructor */
ScalaJS.h.Lcom_grisoft_panels_ElementsUtils$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_panels_ElementsUtils$.prototype = ScalaJS.c.Lcom_grisoft_panels_ElementsUtils$.prototype;
ScalaJS.c.Lcom_grisoft_panels_ElementsUtils$.prototype.makeFieldSpinner__I__I__I__I__Lorg_scalajs_dom_raw_HTMLInputElement = (function(min, max, step, value) {
  var spinner = ScalaJS.g["document"]["createElement"]("input");
  spinner["type"] = "number";
  spinner["min"] = ("" + min);
  spinner["max"] = ("" + max);
  spinner["step"] = ("" + step);
...
ScalaJS.c.Lcom_grisoft_panels_ElementsUtils$.prototype.makeFieldDouble__D__Lorg_scalajs_dom_raw_HTMLInputElement = (function(value) {
  var field = ScalaJS.g["document"]["createElement"]("input");
  field["type"] = "number";
  field["value"] = ("" + value);
  return field
});
ScalaJS.c.Lcom_grisoft_panels_ElementsUtils$.prototype.makeFieldset__T__Lorg_scalajs_dom_raw_HTMLFieldSetElement = (function(name) {
  var fs = ScalaJS.g["document"]["createElement"]("fieldset");
  var legend = ScalaJS.g["document"]["createElement"]("legend");
  legend["appendChild"](this.makeFieldText__T__Lorg_scalajs_dom_raw_Text(name));
  fs["appendChild"](legend);
  return fs
});
ScalaJS.c.Lcom_grisoft_panels_ElementsUtils$.prototype.makeFieldText__T__Lorg_scalajs_dom_raw_Text = (function(text) {
  return ScalaJS.g["document"]["createTextNode"](text)
});
ScalaJS.d.Lcom_grisoft_panels_ElementsUtils$ = new ScalaJS.ClassTypeData({
  Lcom_grisoft_panels_ElementsUtils$: 0
}, false, "com.grisoft.panels.ElementsUtils$", {
  Lcom_grisoft_panels_ElementsUtils$: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_panels_ElementsUtils$.prototype.$classData = ScalaJS.d.Lcom_grisoft_panels_ElementsUtils$;
ScalaJS.n.Lcom_grisoft_panels_ElementsUtils$ = (void 0);
ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$ = (function() {
  if ((!ScalaJS.n.Lcom_grisoft_panels_ElementsUtils$)) {
    ScalaJS.n.Lcom_grisoft_panels_ElementsUtils$ = new ScalaJS.c.Lcom_grisoft_panels_ElementsUtils$().init___()
  };
  return ScalaJS.n.Lcom_grisoft_panels_ElementsUtils$
});
/** @constructor */
ScalaJS.c.Lcom_grisoft_panels_TableTwoCols = (function() {
  ScalaJS.c.O.call(this);
  this.tableMain$1 = null;
  this.tableRow$1 = null;
  this.tablecellLeft$1 = null;
  this.tablecellRight$1 = null
});
ScalaJS.c.Lcom_grisoft_panels_TableTwoCols.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_panels_TableTwoCols.prototype.constructor = ScalaJS.c.Lcom_grisoft_panels_TableTwoCols;
/** @constructor */
ScalaJS.h.Lcom_grisoft_panels_TableTwoCols = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_panels_TableTwoCols.prototype = ScalaJS.c.Lcom_grisoft_panels_TableTwoCols.prototype;
ScalaJS.c.Lcom_grisoft_panels_TableTwoCols.prototype.init___ = (function() {
  this.tableMain$1 = ScalaJS.g["document"]["createElement"]("table");
  this.tableRow$1 = ScalaJS.g["document"]["createElement"]("tr");
  this.tablecellLeft$1 = ScalaJS.g["document"]["createElement"]("td");
  this.tablecellRight$1 = ScalaJS.g["document"]["createElement"]("td");
  this.tableMain$1["appendChild"](this.tableRow$1);
  this.tableRow$1["appendChild"](this.tablecellLeft$1);
  this.tableRow$1["appendChild"](this.tablecellRight$1);
  return this
});
ScalaJS.d.Lcom_grisoft_panels_TableTwoCols = new ScalaJS.ClassTypeData({
  Lcom_grisoft_panels_TableTwoCols: 0
}, false, "com.grisoft.panels.TableTwoCols", {
  Lcom_grisoft_panels_TableTwoCols: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_panels_TableTwoCols.prototype.$classData = ScalaJS.d.Lcom_grisoft_panels_TableTwoCols;
/** @constructor */
ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri = (function() {
  ScalaJS.c.O.call(this);
  this.re$1 = 0.0;
  this.im$1 = 0.0
});
ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri.prototype.constructor = ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri;
/** @constructor */
ScalaJS.h.Lcom_grisoft_scala_grimath_ComplexGri = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_scala_grimath_ComplexGri.prototype = ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri.prototype;
ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri.prototype.timesSelf__Lcom_grisoft_scala_grimath_ComplexGri__V = (function(b) {
  var real = ((this.re$1 * b.re$1) - (this.im$1 * b.im$1));
  var imag = ((this.re$1 * b.im$1) + (this.im$1 * b.re$1));
  this.re$1 = real;
  this.im$1 = imag
});
ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri.prototype.toString__T = (function() {
  if ((this.im$1 < 0)) {
    return ((((("{" + this.re$1) + " -") + "i") + (-this.im$1)) + "}")
  };
  return ((((("{" + this.re$1) + " + ") + " i") + this.im$1) + "}")
});
ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri.prototype.init___D__D = (function(re, im) {
  this.re$1 = re;
  this.im$1 = im;
  return this
});
ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri.prototype.plusSelf__Lcom_grisoft_scala_grimath_ComplexGri__V = (function(b) {
  this.re$1 = (this.re$1 + b.re$1);
  this.im$1 = (this.im$1 + b.im$1)
});
ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri.prototype.times__D__Lcom_grisoft_scala_grimath_ComplexGri = (function(alpha) {
  return new ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri().init___D__D((alpha * this.re$1), (alpha * this.im$1))
});
ScalaJS.is.Lcom_grisoft_scala_grimath_ComplexGri = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_grisoft_scala_grimath_ComplexGri)))
});
ScalaJS.as.Lcom_grisoft_scala_grimath_ComplexGri = (function(obj) {
  return ((ScalaJS.is.Lcom_grisoft_scala_grimath_ComplexGri(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.grisoft.scala.grimath.ComplexGri"))
});
ScalaJS.isArrayOf.Lcom_grisoft_scala_grimath_ComplexGri = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_grisoft_scala_grimath_ComplexGri)))
});
ScalaJS.asArrayOf.Lcom_grisoft_scala_grimath_ComplexGri = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_grisoft_scala_grimath_ComplexGri(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.grisoft.scala.grimath.ComplexGri;", depth))
});
ScalaJS.d.Lcom_grisoft_scala_grimath_ComplexGri = new ScalaJS.ClassTypeData({
  Lcom_grisoft_scala_grimath_ComplexGri: 0
}, false, "com.grisoft.scala.grimath.ComplexGri", {
  Lcom_grisoft_scala_grimath_ComplexGri: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri.prototype.$classData = ScalaJS.d.Lcom_grisoft_scala_grimath_ComplexGri;
/** @constructor */
ScalaJS.c.Lcom_grisoft_scala_grimath_GriDFT$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.Lcom_grisoft_scala_grimath_GriDFT$.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_scala_grimath_GriDFT$.prototype.constructor = ScalaJS.c.Lcom_grisoft_scala_grimath_GriDFT$;
/** @constructor */
ScalaJS.h.Lcom_grisoft_scala_grimath_GriDFT$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_scala_grimath_GriDFT$.prototype = ScalaJS.c.Lcom_grisoft_scala_grimath_GriDFT$.prototype;
ScalaJS.c.Lcom_grisoft_scala_grimath_GriDFT$.prototype.getOneDFT__sci_List__Lcom_grisoft_scala_grimath_ComplexGri__I__Lcom_grisoft_scala_grimath_ComplexGri = (function(data, wkMin, N) {
  var elem = new ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri().init___D__D(1.0, 0.0);
  var edi = new ScalaJS.c.sr_ObjectRef().init___O(elem);
  var elem$1 = new ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri().init___D__D(0.0, 0.0);
  var sum = new ScalaJS.c.sr_ObjectRef().init___O(elem$1);
  var f = (function(wkMin$2, edi$1, sum$1) {
    return (function(dd$2) {
      var dd = ScalaJS.uD(dd$2);
      ScalaJS.as.Lcom_grisoft_scala_grimath_ComplexGri(sum$1.elem$1).plusSelf__Lcom_grisoft_scala_grimath_ComplexGri__V(ScalaJS.as.Lcom_grisoft_scala_grimath_ComplexGri(edi$1.elem$1).times__D__Lcom_grisoft_scala_grimath_ComplexGri(dd));
      ScalaJS.as.Lcom_grisoft_scala_grimath_ComplexGri(edi$1.elem$1).timesSelf__Lcom_grisoft_scala_grimath_ComplexGri__V(wkMin$2)
    })
  })(wkMin, edi, sum);
  var this$3 = ScalaJS.m.sci_List$();
  var bf = this$3.ReusableCBFInstance$2;
  if ((bf === ScalaJS.m.sci_List$().ReusableCBFInstance$2)) {
    if ((data !== ScalaJS.m.sci_Nil$())) {
      var arg1 = data.head__O();
      var h = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(f(arg1), ScalaJS.m.sci_Nil$());
      var t = h;
      var rest = data.tail__sci_List();
    ...
    var b = ScalaJS.s.sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(data, bf);
    var these = data;
  ...
  return ScalaJS.as.Lcom_grisoft_scala_grimath_ComplexGri(sum.elem$1)
});
ScalaJS.c.Lcom_grisoft_scala_grimath_GriDFT$.prototype.dft__sci_List__I__D__sci_List = (function(data, N, kof) {
  var wk = (((-6.283185307179586) / ScalaJS.imul(N, ScalaJS.s.sc_LinearSeqOptimized$class__length__sc_LinearSeqOptimized__I(data))) * kof);
  var wkMin = new ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri().init___D__D(ScalaJS.uD(ScalaJS.g["Math"]["cos"](wk)), ScalaJS.uD(ScalaJS.g["Math"]["sin"](wk)));
  var elem = new ScalaJS.c.Lcom_grisoft_scala_grimath_ComplexGri().init___D__D(ScalaJS.uD(ScalaJS.g["Math"]["cos"](wk)), ScalaJS.uD(ScalaJS.g["Math"]["sin"](wk)));
  var elem$1 = null;
  elem$1 = elem;
  var elem$2 = ScalaJS.m.sci_Nil$();
  var elem$1$1 = null;
  elem$1$1 = elem$2;
  var isEmpty$4 = (N < 0);
  ...
  if ((numRangeElements$4 < 0)) {
    ScalaJS.m.sci_Range$().scala$collection$immutable$Range$$fail__I__I__I__Z__sr_Nothing$(0, N, 1, true)
  };
  if ((numRangeElements$4 < 0)) {
    ScalaJS.m.sci_Range$().scala$collection$immutable$Range$$fail__I__I__I__Z__sr_Nothing$(0, N, 1, true)
  };
  ...
  while ((i !== terminalElement$4)) {
    var arg1 = i;
    var res = ScalaJS.m.Lcom_grisoft_scala_grimath_GriDFT$().getOneDFT__sci_List__Lcom_grisoft_scala_grimath_ComplexGri__I__Lcom_grisoft_scala_grimath_ComplexGri(data, ScalaJS.as.Lcom_grisoft_scala_grimath_ComplexGri(elem$1), N);
    var this$17 = ScalaJS.as.sci_List(elem$1$1);
    elem$1$1 = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(res, this$17);
    ScalaJS.as.Lcom_grisoft_scala_grimath_ComplexGri(elem$1).timesSelf__Lcom_grisoft_scala_grimath_ComplexGri__V(wkMin);
    var elem$3 = (void 0);
    b.$$plus$eq__O__sci_VectorBuilder(elem$3);
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  };
  b.result__sci_Vector();
  return ScalaJS.as.sci_List(elem$1$1)
});
ScalaJS.d.Lcom_grisoft_scala_grimath_GriDFT$ = new ScalaJS.ClassTypeData({
  Lcom_grisoft_scala_grimath_GriDFT$: 0
}, false, "com.grisoft.scala.grimath.GriDFT$", {
  Lcom_grisoft_scala_grimath_GriDFT$: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_scala_grimath_GriDFT$.prototype.$classData = ScalaJS.d.Lcom_grisoft_scala_grimath_GriDFT$;
ScalaJS.n.Lcom_grisoft_scala_grimath_GriDFT$ = (void 0);
ScalaJS.m.Lcom_grisoft_scala_grimath_GriDFT$ = (function() {
  if ((!ScalaJS.n.Lcom_grisoft_scala_grimath_GriDFT$)) {
    ScalaJS.n.Lcom_grisoft_scala_grimath_GriDFT$ = new ScalaJS.c.Lcom_grisoft_scala_grimath_GriDFT$().init___()
  };
  return ScalaJS.n.Lcom_grisoft_scala_grimath_GriDFT$
});
/** @constructor */
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GraphicsJS = (function() {
  ScalaJS.c.O.call(this);
  this.canvas$1 = null;
  this.ctx$1 = null;
  this.color$1 = null
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GraphicsJS.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GraphicsJS.prototype.constructor = ScalaJS.c.Lcom_grisoft_scala_histogram_model_GraphicsJS;
/** @constructor */
ScalaJS.h.Lcom_grisoft_scala_histogram_model_GraphicsJS = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_scala_histogram_model_GraphicsJS.prototype = ScalaJS.c.Lcom_grisoft_scala_histogram_model_GraphicsJS.prototype;
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GraphicsJS.prototype.init___Lorg_scalajs_dom_raw_HTMLCanvasElement = (function(canvas) {
  this.canvas$1 = canvas;
  this.ctx$1 = canvas["getContext"]("2d");
  this.color$1 = "#ff0000";
  return this
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GraphicsJS.prototype.drawLine__I__I__I__I__T__V = (function(x0, y0, x1, y1, col) {
  this.ctx$1["beginPath"]();
  this.ctx$1["moveTo"](x0, y0);
  this.ctx$1["lineTo"](x1, y1);
  this.ctx$1["closePath"]();
  this.ctx$1["strokeStyle"] = col;
  this.ctx$1["stroke"]()
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GraphicsJS.prototype.fillRect__I__I__I__I__T__V = (function(x, y, dx, dy, col) {
  this.ctx$1["fillRect"](x, y, dx, dy);
  this.ctx$1["strokeStyle"] = col;
  this.ctx$1["stroke"]()
});
ScalaJS.d.Lcom_grisoft_scala_histogram_model_GraphicsJS = new ScalaJS.ClassTypeData({
  Lcom_grisoft_scala_histogram_model_GraphicsJS: 0
}, false, "com.grisoft.scala.histogram.model.GraphicsJS", {
  Lcom_grisoft_scala_histogram_model_GraphicsJS: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GraphicsJS.prototype.$classData = ScalaJS.d.Lcom_grisoft_scala_histogram_model_GraphicsJS;
/** @constructor */
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram = (function() {
  ScalaJS.c.O.call(this);
  this.id$1 = ScalaJS.m.sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong();
  this.data$1 = null;
  this.color$1 = null;
  this.histRec$1 = null
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype.constructor = ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram;
/** @constructor */
ScalaJS.h.Lcom_grisoft_scala_histogram_model_GriHistogram = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype = ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype;
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype.init___ = (function() {
  this.id$1 = ScalaJS.m.jl_System$().nanoTime__J();
  this.color$1 = "#00ffff";
  this.histRec$1 = new ScalaJS.c.Lcom_grisoft_scala_util_Rectangle2DGri().init___D__D__D__D(ScalaJS.m.s_Double$().MinValue$1, ScalaJS.m.s_Double$().MinValue$1, 1.7976931348623157E308, 1.7976931348623157E308);
  return this
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype.makeZeroByIntegral__V = (function() {
  this.data$1 = ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().makeZeroByIntegral__sci_List__sci_List(this.data$1);
  this.loadHistogram__V()
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype.loadHistogram__V = (function() {
  var this$2 = this.data$1;
  var f = (function(aa$2) {
    var aa = ScalaJS.as.T2(aa$2);
    return new ScalaJS.c.Lcom_grisoft_scala_util_Point2DGri().init___D__D(aa.$$und1$mcD$sp__D(), aa.$$und2$mcD$sp__D())
  });
  ...
  var pointsList = ScalaJS.as.sci_List(jsx$1);
  this.histRec$1 = this.getMaxMinRec__sci_List__Lcom_grisoft_scala_util_Rectangle2DGri(pointsList)
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype.setMulMinusY__V = (function() {
  var this$2 = this.data$1;
  var f = (function(aa$2) {
    var aa = ScalaJS.as.T2(aa$2);
    return new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D(aa.$$und1$mcD$sp__D(), (-aa.$$und2$mcD$sp__D()))
  });
  var this$1 = ScalaJS.m.sci_List$();
  var bf = this$1.ReusableCBFInstance$2;
  if ((bf === ScalaJS.m.sci_List$().ReusableCBFInstance$2)) {
  ...
  this.data$1 = ScalaJS.as.sci_List(jsx$1);
  this.loadHistogram__V()
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype.loadHistogram__sci_List__V = (function(dd) {
  this.data$1 = dd;
  this.loadHistogram__V()
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype.getMaxMinRec__sci_List__Lcom_grisoft_scala_util_Rectangle2DGri = (function(l) {
  var minX = new ScalaJS.c.sr_DoubleRef().init___D(1.7976931348623157E308);
  var elem = ScalaJS.m.s_Double$().MinValue$1;
  var maxX = new ScalaJS.c.sr_DoubleRef().init___D(elem);
  var minY = new ScalaJS.c.sr_DoubleRef().init___D(1.7976931348623157E308);
  var elem$1 = ScalaJS.m.s_Double$().MinValue$1;
  var maxY = new ScalaJS.c.sr_DoubleRef().init___D(elem$1);
  var p = new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(check$ifrefutable$1$2) {
    var check$ifrefutable$1 = ScalaJS.as.Lcom_grisoft_scala_util_Point2DGri(check$ifrefutable$1$2);
    return (check$ifrefutable$1 !== null)
  }));
  new ScalaJS.c.sc_TraversableLike$WithFilter().init___sc_TraversableLike__F1(l, p).foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(minX$1, maxX$1, minY$1, maxY$1) {
    return (function(histShowPoint$2) {
      var histShowPoint = ScalaJS.as.Lcom_grisoft_scala_util_Point2DGri(histShowPoint$2);
      var x = minX$1.elem$1;
      var y = histShowPoint.x$1;
      minX$1.elem$1 = ((x < y) ? x : y);
      var x$1 = minY$1.elem$1;
      var y$1 = histShowPoint.y$1;
      minY$1.elem$1 = ((x$1 < y$1) ? x$1 : y$1);
      var x$2 = maxX$1.elem$1;
      var y$2 = histShowPoint.x$1;
      maxX$1.elem$1 = ((x$2 > y$2) ? x$2 : y$2);
      var x$3 = maxY$1.elem$1;
      var y$3 = histShowPoint.y$1;
      maxY$1.elem$1 = ((x$3 > y$3) ? x$3 : y$3)
    })
  })(minX, maxX, minY, maxY)));
  return new ScalaJS.c.Lcom_grisoft_scala_util_Rectangle2DGri().init___D__D__D__D(minX.elem$1, minY.elem$1, (maxX.elem$1 - minX.elem$1), (maxY.elem$1 - minY.elem$1))
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype.setMulMinusX__V = (function() {
  var this$2 = this.data$1;
  var f = (function(aa$2) {
    var aa = ScalaJS.as.T2(aa$2);
    return new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D((-aa.$$und1$mcD$sp__D()), aa.$$und2$mcD$sp__D())
...
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype.init___sci_List = (function(dd) {
  ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype.init___.call(this);
  this.data$1 = dd;
  this.loadHistogram__sci_List__V(dd);
  return this
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype.makePoKoncam__V = (function() {
  this.data$1 = ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().makePoKoncam__sci_List__sci_List(this.data$1);
  this.loadHistogram__V()
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype.showHistogram__Lcom_grisoft_scala_histogram_model_GraphicsJS__Lcom_grisoft_scala_histogram_model_HistogramFields__V = (function(graphicsJS, histogramFields) {
  var elem$1 = 0;
  elem$1 = 0;
  var elem$1$1 = null;
  elem$1$1 = null;
  var elem$1$2 = null;
  elem$1$2 = null;
  var c = graphicsJS.color$1;
  var col = this.color$1;
  graphicsJS.color$1 = col;
  var this$4 = this.data$1;
  var these = this$4;
  while ((!these.isEmpty__Z())) {
    var arg1 = these.head__O();
    var d2P = ScalaJS.as.T2(arg1);
    if ((elem$1 === 0)) {
      var _1$mcD$sp = d2P.$$und1$mcD$sp__D();
      var _2$mcD$sp = d2P.$$und2$mcD$sp__D();
      var p = new ScalaJS.c.Lcom_grisoft_scala_util_PointGri().init___I__I(0, 0);
      p.x$1 = ((histogramFields.rec$1.$$und1$mcI$sp__I() * ((_1$mcD$sp - histogramFields.fieldRec$1.x$1) / histogramFields.fieldRec$1.w$1)) | 0);
      p.y$1 = ((histogramFields.rec$1.$$und2$mcI$sp__I() - ((histogramFields.rec$1.$$und2$mcI$sp__I() * ((_2$mcD$sp - histogramFields.fieldRec$1.y$1) / histogramFields.fieldRec$1.h$1)) | 0)) | 0);
      elem$1$2 = p;
      elem$1 = ((1 + elem$1) | 0)
    } else {
      var _1$mcD$sp$1 = d2P.$$und1$mcD$sp__D();
      var _2$mcD$sp$1 = d2P.$$und2$mcD$sp__D();
      var p$1 = new ScalaJS.c.Lcom_grisoft_scala_util_PointGri().init___I__I(0, 0);
      p$1.x$1 = ((histogramFields.rec$1.$$und1$mcI$sp__I() * ((_1$mcD$sp$1 - histogramFields.fieldRec$1.x$1) / histogramFields.fieldRec$1.w$1)) | 0);
      p$1.y$1 = ((histogramFields.rec$1.$$und2$mcI$sp__I() - ((histogramFields.rec$1.$$und2$mcI$sp__I() * ((_2$mcD$sp$1 - histogramFields.fieldRec$1.y$1) / histogramFields.fieldRec$1.h$1)) | 0)) | 0);
      elem$1$2 = p$1;
      graphicsJS.drawLine__I__I__I__I__T__V(ScalaJS.as.Lcom_grisoft_scala_util_PointGri(elem$1$1).x$1, ScalaJS.as.Lcom_grisoft_scala_util_PointGri(elem$1$1).y$1, ScalaJS.as.Lcom_grisoft_scala_util_PointGri(elem$1$2).x$1, ScalaJS.as.Lcom_grisoft_scala_util_PointGri(elem$1$2).y$1, "#ffff00")
    };
    elem$1$1 = ScalaJS.as.Lcom_grisoft_scala_util_PointGri(elem$1$2);
    var this$5 = these;
    these = this$5.tail__sci_List()
  };
  graphicsJS.color$1 = c
});
ScalaJS.is.Lcom_grisoft_scala_histogram_model_GriHistogram = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_grisoft_scala_histogram_model_GriHistogram)))
});
ScalaJS.as.Lcom_grisoft_scala_histogram_model_GriHistogram = (function(obj) {
  return ((ScalaJS.is.Lcom_grisoft_scala_histogram_model_GriHistogram(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.grisoft.scala.histogram.model.GriHistogram"))
});
ScalaJS.isArrayOf.Lcom_grisoft_scala_histogram_model_GriHistogram = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_grisoft_scala_histogram_model_GriHistogram)))
});
ScalaJS.asArrayOf.Lcom_grisoft_scala_histogram_model_GriHistogram = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_grisoft_scala_histogram_model_GriHistogram(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.grisoft.scala.histogram.model.GriHistogram;", depth))
});
ScalaJS.d.Lcom_grisoft_scala_histogram_model_GriHistogram = new ScalaJS.ClassTypeData({
  Lcom_grisoft_scala_histogram_model_GriHistogram: 0
}, false, "com.grisoft.scala.histogram.model.GriHistogram", {
  Lcom_grisoft_scala_histogram_model_GriHistogram: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram.prototype.$classData = ScalaJS.d.Lcom_grisoft_scala_histogram_model_GriHistogram;
/** @constructor */
ScalaJS.c.Lcom_grisoft_scala_histogram_model_HistogramFields = (function() {
  ScalaJS.c.O.call(this);
  this.rec$1 = null;
  this.color$1 = null;
  this.fieldRec$1 = null;
  this.histList$1 = null
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_HistogramFields.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_scala_histogram_model_HistogramFields.prototype.constructor = ScalaJS.c.Lcom_grisoft_scala_histogram_model_HistogramFields;
/** @constructor */
ScalaJS.h.Lcom_grisoft_scala_histogram_model_HistogramFields = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_scala_histogram_model_HistogramFields.prototype = ScalaJS.c.Lcom_grisoft_scala_histogram_model_HistogramFields.prototype;
ScalaJS.c.Lcom_grisoft_scala_histogram_model_HistogramFields.prototype.init___T2 = (function(rec) {
  this.rec$1 = rec;
  this.color$1 = "#000000";
  this.fieldRec$1 = null;
  this.histList$1 = ScalaJS.m.sci_Nil$();
  return this
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_HistogramFields.prototype.showAllHistogram__Lcom_grisoft_scala_histogram_model_GraphicsJS__V = (function(g) {
  if ((this.rec$1 !== null)) {
    var c = g.color$1;
    var col = this.color$1;
    g.color$1 = col;
    g.fillRect__I__I__I__I__T__V(0, 0, this.rec$1.$$und1$mcI$sp__I(), this.rec$1.$$und2$mcI$sp__I(), "#aaaaaa");
    var this$1 = this.histList$1;
    var p = new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(check$ifrefutable$3$2) {
      var check$ifrefutable$3 = ScalaJS.as.Lcom_grisoft_scala_histogram_model_GriHistogram(check$ifrefutable$3$2);
      return (check$ifrefutable$3 !== null)
    }));
    new ScalaJS.c.sc_TraversableLike$WithFilter().init___sc_TraversableLike__F1(this$1, p).foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer, g$1) {
      return (function(griHistogram$2) {
        var griHistogram = ScalaJS.as.Lcom_grisoft_scala_histogram_model_GriHistogram(griHistogram$2);
        griHistogram.showHistogram__Lcom_grisoft_scala_histogram_model_GraphicsJS__Lcom_grisoft_scala_histogram_model_HistogramFields__V(g$1, arg$outer)
      })
    })(this, g)));
    g.color$1 = c
  }
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_HistogramFields.prototype.setOneGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V = (function(griHistogram) {
  var this$1 = ScalaJS.m.sci_Nil$();
  this.histList$1 = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(griHistogram, this$1);
  this.fieldRec$1 = this.getMaxMinRec__Lcom_grisoft_scala_util_Rectangle2DGri()
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_HistogramFields.prototype.showZero__Lcom_grisoft_scala_histogram_model_GraphicsJS__V = (function(g) {
  var this$1 = this.histList$1;
  if ((ScalaJS.s.sc_LinearSeqOptimized$class__length__sc_LinearSeqOptimized__I(this$1) > 0)) {
    var c = g.color$1;
    g.color$1 = "#00ff00";
    var p = new ScalaJS.c.Lcom_grisoft_scala_util_PointGri().init___I__I(0, 0);
    p.x$1 = ((this.rec$1.$$und1$mcI$sp__I() * ((-this.fieldRec$1.x$1) / this.fieldRec$1.w$1)) | 0);
    p.y$1 = ((this.rec$1.$$und2$mcI$sp__I() - ((this.rec$1.$$und2$mcI$sp__I() * ((-this.fieldRec$1.y$1) / this.fieldRec$1.h$1)) | 0)) | 0);
    g.drawLine__I__I__I__I__T__V(0, p.y$1, this.rec$1.$$und1$mcI$sp__I(), p.y$1, "#ff0000");
    g.drawLine__I__I__I__I__T__V(p.x$1, 0, p.x$1, this.rec$1.$$und2$mcI$sp__I(), "#ff0000");
    g.color$1 = c
  }
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_HistogramFields.prototype.getMaxMinRec__Lcom_grisoft_scala_util_Rectangle2DGri = (function() {
  var minX = new ScalaJS.c.sr_DoubleRef().init___D(1.7976931348623157E308);
  var elem = ScalaJS.m.s_Double$().MinValue$1;
  var maxX = new ScalaJS.c.sr_DoubleRef().init___D(elem);
  var minY = new ScalaJS.c.sr_DoubleRef().init___D(1.7976931348623157E308);
  var elem$1 = ScalaJS.m.s_Double$().MinValue$1;
  var maxY = new ScalaJS.c.sr_DoubleRef().init___D(elem$1);
  var x = this.histList$1;
  var x$2 = ScalaJS.m.sci_Nil$();
  if ((!((x === null) ? (x$2 === null) : x.equals__O__Z(x$2)))) {
    var this$5 = this.histList$1;
    var p = new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(check$ifrefutable$2$2) {
      var check$ifrefutable$2 = ScalaJS.as.Lcom_grisoft_scala_histogram_model_GriHistogram(check$ifrefutable$2$2);
      return (check$ifrefutable$2 !== null)
    }));
    new ScalaJS.c.sc_TraversableLike$WithFilter().init___sc_TraversableLike__F1(this$5, p).foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(minX$1, maxX$1, minY$1, maxY$1) {
      return (function(griHistogram$2) {
        var griHistogram = ScalaJS.as.Lcom_grisoft_scala_histogram_model_GriHistogram(griHistogram$2);
        var x$1 = minX$1.elem$1;
        var y = griHistogram.histRec$1.x$1;
        minX$1.elem$1 = ((x$1 < y) ? x$1 : y);
        var x$3 = minY$1.elem$1;
        var y$1 = griHistogram.histRec$1.y$1;
        minY$1.elem$1 = ((x$3 < y$1) ? x$3 : y$1);
        var x$4 = maxX$1.elem$1;
        var y$2 = (griHistogram.histRec$1.x$1 + griHistogram.histRec$1.w$1);
        maxX$1.elem$1 = ((x$4 > y$2) ? x$4 : y$2);
        var x$5 = maxY$1.elem$1;
        var y$3 = (griHistogram.histRec$1.y$1 + griHistogram.histRec$1.h$1);
        maxY$1.elem$1 = ((x$5 > y$3) ? x$5 : y$3)
      })
    })(minX, maxX, minY, maxY)))
  };
  return new ScalaJS.c.Lcom_grisoft_scala_util_Rectangle2DGri().init___D__D__D__D(minX.elem$1, minY.elem$1, (maxX.elem$1 - minX.elem$1), (maxY.elem$1 - minY.elem$1))
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_HistogramFields.prototype.addGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V = (function(griHistogram) {
  var this$1 = this.histList$1;
  this.histList$1 = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(griHistogram, this$1);
  this.fieldRec$1 = this.getMaxMinRec__Lcom_grisoft_scala_util_Rectangle2DGri()
});
ScalaJS.d.Lcom_grisoft_scala_histogram_model_HistogramFields = new ScalaJS.ClassTypeData({
  Lcom_grisoft_scala_histogram_model_HistogramFields: 0
}, false, "com.grisoft.scala.histogram.model.HistogramFields", {
  Lcom_grisoft_scala_histogram_model_HistogramFields: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_scala_histogram_model_HistogramFields.prototype.$classData = ScalaJS.d.Lcom_grisoft_scala_histogram_model_HistogramFields;
/** @constructor */
ScalaJS.c.Lcom_grisoft_scala_histogram_panel_PanelHistogr = (function() {
  ScalaJS.c.O.call(this);
  this.canvas$1 = null;
  this.graphicsJS$1 = null;
  this.wh$1 = null;
  this.histogramFields$1 = null;
  this.mouseX$1 = 0;
  this.mouseY$1 = 0;
  this.mouseclicked$1 = false
});
ScalaJS.c.Lcom_grisoft_scala_histogram_panel_PanelHistogr.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_scala_histogram_panel_PanelHistogr.prototype.constructor = ScalaJS.c.Lcom_grisoft_scala_histogram_panel_PanelHistogr;
/** @constructor */
ScalaJS.h.Lcom_grisoft_scala_histogram_panel_PanelHistogr = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_scala_histogram_panel_PanelHistogr.prototype = ScalaJS.c.Lcom_grisoft_scala_histogram_panel_PanelHistogr.prototype;
ScalaJS.c.Lcom_grisoft_scala_histogram_panel_PanelHistogr.prototype.init___Lorg_scalajs_dom_raw_HTMLCanvasElement = (function(canvas) {
  this.canvas$1 = canvas;
  this.graphicsJS$1 = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_GraphicsJS().init___Lorg_scalajs_dom_raw_HTMLCanvasElement(canvas);
  this.wh$1 = new ScalaJS.c.s_Tuple2$mcII$sp().init___I__I(ScalaJS.uI(canvas["width"]), ScalaJS.uI(canvas["height"]));
  this.histogramFields$1 = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_HistogramFields().init___T2(this.wh$1);
  this.mouseX$1 = 0;
  this.mouseY$1 = 0;
  this.mouseclicked$1 = false;
  return this
});
ScalaJS.c.Lcom_grisoft_scala_histogram_panel_PanelHistogr.prototype.paint__V = (function() {
  if ((this.histogramFields$1 !== null)) {
    this.histogramFields$1.showAllHistogram__Lcom_grisoft_scala_histogram_model_GraphicsJS__V(this.graphicsJS$1);
    this.histogramFields$1.showZero__Lcom_grisoft_scala_histogram_model_GraphicsJS__V(this.graphicsJS$1)
  }
});
ScalaJS.c.Lcom_grisoft_scala_histogram_panel_PanelHistogr.prototype.getData__I__sci_List = (function(indx) {
  var this$1 = this.histogramFields$1.histList$1;
  return ScalaJS.as.Lcom_grisoft_scala_histogram_model_GriHistogram(ScalaJS.s.sc_LinearSeqOptimized$class__apply__sc_LinearSeqOptimized__I__O(this$1, indx)).data$1
});
ScalaJS.d.Lcom_grisoft_scala_histogram_panel_PanelHistogr = new ScalaJS.ClassTypeData({
  Lcom_grisoft_scala_histogram_panel_PanelHistogr: 0
}, false, "com.grisoft.scala.histogram.panel.PanelHistogr", {
  Lcom_grisoft_scala_histogram_panel_PanelHistogr: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_scala_histogram_panel_PanelHistogr.prototype.$classData = ScalaJS.d.Lcom_grisoft_scala_histogram_panel_PanelHistogr;
/** @constructor */
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$ = (function() {
  ScalaJS.c.O.call(this);
  this.APROX$undERR$1 = 0
});
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.constructor = ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$;
/** @constructor */
ScalaJS.h.Lcom_grisoft_scala_util_CsvUtils$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_scala_util_CsvUtils$.prototype = ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype;
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.griNPletGaussPick__I__D__D__D__D__sci_List = (function(nN, shift, widthLine, split, nPascal) {
  var this$4 = new ScalaJS.c.sci_Range$Inclusive().init___I__I__I(0, nN, 1);
  var this$5 = ScalaJS.m.sci_List$();
  var cbf = this$5.ReusableCBFInstance$2;
  var this$7 = ScalaJS.as.sci_List(ScalaJS.s.sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(this$4, cbf));
  var f = (function(shift$4, widthLine$3, split$3, nPascal$3) {
    return (function(p$2) {
      var p = ScalaJS.uI(p$2);
      return new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D((p - shift$4), ScalaJS.m.Lcom_grisoft_scala_util_GriMathUtil$().griNPletGaussPick__D__D__D__D__D((p - shift$4), widthLine$3, split$3, nPascal$3))
    })
  })(shift, widthLine, split, nPascal);
  var this$6 = ScalaJS.m.sci_List$();
  var bf = this$6.ReusableCBFInstance$2;
  if ((bf === ScalaJS.m.sci_List$().ReusableCBFInstance$2)) {
    if ((this$7 === ScalaJS.m.sci_Nil$())) {
      var jsx$1 = ScalaJS.m.sci_Nil$()
    } else {
    ...
    var b = ScalaJS.s.sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(this$7, bf);
    var these = this$7;
    while ((!these.isEmpty__Z())) {
      var arg1$2 = these.head__O();
      b.$$plus$eq__O__scm_Builder(f(arg1$2));
  ...
  var liRet = ScalaJS.as.sci_List(jsx$1);
  return liRet
});
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.init___ = (function() {
  ScalaJS.n.Lcom_grisoft_scala_util_CsvUtils$ = this;
  this.APROX$undERR$1 = 0;
  return this
});
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.getYAproximValue__D__sci_List__D = (function(dX, data) {
  var x = ((ScalaJS.as.T2(data.head__O()).$$und1$mcD$sp__D() - ScalaJS.as.T2(ScalaJS.s.sc_LinearSeqOptimized$class__last__sc_LinearSeqOptimized__O(data)).$$und1$mcD$sp__D()) / (((-1) + ScalaJS.s.sc_LinearSeqOptimized$class__length__sc_LinearSeqOptimized__I(data)) | 0));
  var delX = ((x < 0) ? (-x) : x);
  var dY = this.APROX$undERR$1;
  inlinereturn$5: {
    var these = data;
    while ((!these.isEmpty__Z())) {
      var arg1 = these.head__O();
      var p = ScalaJS.as.T2(arg1);
      if ((p.$$und1$mcD$sp__D() === dX)) {
        var x1 = new ScalaJS.c.s_Some().init___O(these.head__O());
  ...
  if (ScalaJS.is.s_Some(x1)) {
    ...
    var x$1 = ScalaJS.as.T2(x2.x$2);
    dY = x$1.$$und2$mcD$sp__D()
  } else {
    var x$2 = ScalaJS.m.s_None$();
    if ((x$2 === x1)) {
      ScalaJS.m.sci_List$();
      ...
      while ((!these$1.isEmpty__Z())) {
        ...
        var p$1 = ScalaJS.as.T2(arg1$1);
        var x$3 = (p$1.$$und1$mcD$sp__D() - dX);
        if ((((x$3 < 0) ? (-x$3) : x$3) < delX)) {
          b.$$plus$eq__O__scm_ListBuffer(arg1$1)
        };
        var this$6 = these$1;
        these$1 = this$6.tail__sci_List()
      };
      var two = b.toList__sci_List();
      if ((ScalaJS.s.sc_LinearSeqOptimized$class__length__sc_LinearSeqOptimized__I(two) === 2)) {
        var dX1 = ScalaJS.as.T2(two.head__O()).$$und1$mcD$sp__D();
        var dY1 = ScalaJS.as.T2(two.head__O()).$$und2$mcD$sp__D();
        var dX2 = ScalaJS.as.T2(ScalaJS.s.sc_LinearSeqOptimized$class__last__sc_LinearSeqOptimized__O(two)).$$und1$mcD$sp__D();
        var dY2 = ScalaJS.as.T2(ScalaJS.s.sc_LinearSeqOptimized$class__last__sc_LinearSeqOptimized__O(two)).$$und2$mcD$sp__D();
        dY = (dY1 + ((dX - dX1) * ((dY2 - dY1) / (dX2 - dX1))))
      }
    } else {
...
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.makeZeroByIntegral__sci_List__sci_List = (function(dd) {
  var elem = this.getSumY__sci_List__D(dd);
  var intgr = new ScalaJS.c.sr_DoubleRef().init___D(elem);
  intgr.elem$1 = (intgr.elem$1 / ScalaJS.s.sc_LinearSeqOptimized$class__length__sc_LinearSeqOptimized__I(dd));
  var f = (function(intgr$1) {
    return (function(aa$2) {
      var aa = ScalaJS.as.T2(aa$2);
      return new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D(aa.$$und1$mcD$sp__D(), (aa.$$und2$mcD$sp__D() - intgr$1.elem$1))
    })
  })(intgr);
  var this$2 = ScalaJS.m.sci_List$();
  var bf = this$2.ReusableCBFInstance$2;
  if ((bf === ScalaJS.m.sci_List$().ReusableCBFInstance$2)) {
    if ((dd === ScalaJS.m.sci_Nil$())) {
      var jsx$1 = ScalaJS.m.sci_Nil$()
    } else {
      var arg1 = dd.head__O();
      var h = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(f(arg1), ScalaJS.m.sci_Nil$());
      var t = h;
      var rest = dd.tail__sci_List();
      while ((rest !== ScalaJS.m.sci_Nil$())) {
        var arg1$1 = rest.head__O();
        var nx = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(f(arg1$1), ScalaJS.m.sci_Nil$());
        t.tl$5 = nx;
    ...
    var b = ScalaJS.s.sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(dd, bf);
    var these = dd;
    while ((!these.isEmpty__Z())) {
      var arg1$2 = these.head__O();
      b.$$plus$eq__O__scm_Builder(f(arg1$2));
...
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.griNPletLorenz__I__D__D__D__D__sci_List = (function(nN, shift, widthLine, split, nPascal) {
  var this$4 = new ScalaJS.c.sci_Range$Inclusive().init___I__I__I(0, nN, 1);
  var this$5 = ScalaJS.m.sci_List$();
  var cbf = this$5.ReusableCBFInstance$2;
  var this$7 = ScalaJS.as.sci_List(ScalaJS.s.sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(this$4, cbf));
  var f = (function(shift$3, widthLine$2, split$2, nPascal$2) {
    return (function(p$2) {
      var p = ScalaJS.uI(p$2);
      return new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D((p - shift$3), ScalaJS.m.Lcom_grisoft_scala_util_GriMathUtil$().griNPletLorenz__D__D__D__D__D((p - shift$3), widthLine$2, split$2, nPascal$2))
    })
  })(shift, widthLine, split, nPascal);
  var this$6 = ScalaJS.m.sci_List$();
  var bf = this$6.ReusableCBFInstance$2;
...
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.getIntegral__sci_List__sci_List = (function(dd) {
  var f = new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(p$2) {
    var p = ScalaJS.as.T2(p$2);
    return p.$$und1$mcD$sp__D()
  }));
  var ord = ScalaJS.m.s_math_Ordering$Double$();
  var dd1 = ScalaJS.as.sci_List(ScalaJS.s.sc_SeqLike$class__sortBy__sc_SeqLike__F1__s_math_Ordering__O(dd, f, ord));
  var sum = new ScalaJS.c.sr_DoubleRef().init___D(0.0);
  var f$1 = (function(sum$1) {
    return (function(aa$2) {
      var aa = ScalaJS.as.T2(aa$2);
      var d = new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D(aa.$$und1$mcD$sp__D(), sum$1.elem$1);
      sum$1.elem$1 = (sum$1.elem$1 + aa.$$und2$mcD$sp__D());
      return d
    })
  })(sum);
  var this$2 = ScalaJS.m.sci_List$();
  var bf = this$2.ReusableCBFInstance$2;
  if ((bf === ScalaJS.m.sci_List$().ReusableCBFInstance$2)) {
    if ((dd1 === ScalaJS.m.sci_Nil$())) {
      var jsx$1 = ScalaJS.m.sci_Nil$()
    } else {
      var arg1 = dd1.head__O();
      var h = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(f$1(arg1), ScalaJS.m.sci_Nil$());
      var t = h;
      var rest = dd1.tail__sci_List();
      while ((rest !== ScalaJS.m.sci_Nil$())) {
        var arg1$1 = rest.head__O();
        var nx = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(f$1(arg1$1), ScalaJS.m.sci_Nil$());
        t.tl$5 = nx;
        t = nx;
        var this$3 = rest;
        rest = this$3.tail__sci_List()
    ...
    var b = ScalaJS.s.sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(dd1, bf);
    var these = dd1;
    while ((!these.isEmpty__Z())) {
      var arg1$2 = these.head__O();
...
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.getKof2Point__T2__T2__D = (function(left, right) {
  return ((right.$$und2$mcD$sp__D() - left.$$und2$mcD$sp__D()) / (right.$$und1$mcD$sp__D() - left.$$und1$mcD$sp__D()))
});
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.makePlus__sci_List__sci_List__D__D__sci_List = (function(dd1, data2, kof, shift) {
  if ((shift !== 0.0)) {
    var f = (function(shift$1) {
      return (function(a$2) {
        var a = ScalaJS.as.T2(a$2);
        return new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D((a.$$und1$mcD$sp__D() - shift$1), a.$$und2$mcD$sp__D())
      })
    })(shift);
    var this$1 = ScalaJS.m.sci_List$();
    var bf = this$1.ReusableCBFInstance$2;
    if ((bf === ScalaJS.m.sci_List$().ReusableCBFInstance$2)) {
      if ((data2 === ScalaJS.m.sci_Nil$())) {
        var jsx$1 = ScalaJS.m.sci_Nil$()
      } else {
        var arg1 = data2.head__O();
        var h = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(f(arg1), ScalaJS.m.sci_Nil$());
        var t = h;
        var rest = data2.tail__sci_List();
        while ((rest !== ScalaJS.m.sci_Nil$())) {
          var arg1$1 = rest.head__O();
          var nx = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(f(arg1$1), ScalaJS.m.sci_Nil$());
          t.tl$5 = nx;
      ...
      var b = ScalaJS.s.sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(data2, bf);
      var these = data2;
      while ((!these.isEmpty__Z())) {
        var arg1$2 = these.head__O();
        b.$$plus$eq__O__scm_Builder(f(arg1$2));
    ...
    var newData2 = ScalaJS.as.sci_List(jsx$1)
  } else {
    var newData2 = data2
  };
  var f$1 = (function(kof$1, newData2$1) {
    return (function(a$2$1) {
      var a$1 = ScalaJS.as.T2(a$2$1);
      return new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D(a$1.$$und1$mcD$sp__D(), (a$1.$$und2$mcD$sp__D() + (kof$1 * ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().getYAproximValue__D__sci_List__D(a$1.$$und1$mcD$sp__D(), newData2$1))))
    })
  })(kof, newData2);
  ...
  if ((bf$1 === ScalaJS.m.sci_List$().ReusableCBFInstance$2)) {
    if ((dd1 === ScalaJS.m.sci_Nil$())) {
      ...
      var arg1$3 = dd1.head__O();
      var h$1 = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(f$1(arg1$3), ScalaJS.m.sci_Nil$());
      var t$1 = h$1;
      var rest$1 = dd1.tail__sci_List();
      while ((rest$1 !== ScalaJS.m.sci_Nil$())) {
        var arg1$4 = rest$1.head__O();
        var nx$1 = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(f$1(arg1$4), ScalaJS.m.sci_Nil$());
        t$1.tl$5 = nx$1;
        t$1 = nx$1;
        var this$5 = rest$1;
        rest$1 = this$5.tail__sci_List()
      };
      var jsx$2 = h$1
    }
  } else {
    var b$1 = ScalaJS.s.sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(dd1, bf$1);
    var these$1 = dd1;
    while ((!these$1.isEmpty__Z())) {
  ...
  var newDataKof = ScalaJS.as.sci_List(jsx$2);
  return newDataKof
});
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.getStringFromData__T__sci_List__T = (function(separator, dd) {
  var sb = new ScalaJS.c.scm_StringBuilder().init___();
  var these = dd;
  while ((!these.isEmpty__Z())) {
    var arg1 = these.head__O();
    var d = ScalaJS.as.T2(arg1);
    sb.append__T__scm_StringBuilder((((("" + d.$$und1$mcD$sp__D()) + separator) + d.$$und2$mcD$sp__D()) + "\n"));
    var this$1 = these;
    these = this$1.tail__sci_List()
  };
  var this$2 = sb.underlying$5;
  return this$2.content$1
});
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.loadFromString__T__T__sci_List = (function(sData, separator) {
  var elem = ScalaJS.m.sci_Nil$();
  var elem$1 = null;
  elem$1 = elem;
  var li = ScalaJS.m.sjsr_RuntimeString$().split__T__T__I__AT(sData, "\n", 0);
  try {
    var i = 0;
    var len = li.u["length"];
    while ((i < len)) {
      var index = i;
      var arg1 = li.u[index];
      var line = ScalaJS.as.T(arg1);
      var a = ScalaJS.m.sjsr_RuntimeString$().split__T__T__I__AT(line, separator, 0);
      var this$8 = new ScalaJS.c.sci_StringOps().init___T(a.u[0]);
      var jsx$1 = ScalaJS.m.jl_Double$().parseDouble__T__D(this$8.repr$1);
      var this$11 = new ScalaJS.c.sci_StringOps().init___T(a.u[1]);
      var x$8 = new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D(jsx$1, ScalaJS.m.jl_Double$().parseDouble__T__D(this$11.repr$1));
      var this$13 = ScalaJS.as.sci_List(elem$1);
      elem$1 = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(x$8, this$13);
      i = ((1 + i) | 0)
    }
  } catch (e) {
    if (ScalaJS.is.jl_NumberFormatException(e)) {
      ScalaJS.as.jl_NumberFormatException(e);
      var this$15 = ScalaJS.m.s_Console$();
      var this$16 = this$15.outVar$2;
      ScalaJS.as.Ljava_io_PrintStream(this$16.tl$1.get__O()).println__O__V("Error!");
      elem$1 = ScalaJS.m.sci_Nil$()
    } else {
      throw e
    }
  };
...
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.getShift2Point__T2__T2__D = (function(left, right) {
  return (left.$$und2$mcD$sp__D() - (this.getKof2Point__T2__T2__D(left, right) * left.$$und1$mcD$sp__D()))
});
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.getSumY__sci_List__D = (function(dd) {
  var elem$1 = 0.0;
  elem$1 = 0.0;
  var these = dd;
  while ((!these.isEmpty__Z())) {
    ...
    elem$1 = (elem$1 + x$7.$$und2$mcD$sp__D());
    var this$2 = these;
    these = this$2.tail__sci_List()
  };
  return elem$1
});
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.griNPletGauss__I__D__D__D__I__sci_List = (function(nN, shift, widthLine, split, nPascal) {
  var x = ((((((((("nN=" + nN) + " shift=") + shift) + " widthLine=") + widthLine) + " split=") + split) + " nPascal=") + nPascal);
  var this$2 = ScalaJS.m.s_Console$();
  var this$3 = this$2.outVar$2;
  ScalaJS.as.Ljava_io_PrintStream(this$3.tl$1.get__O()).println__O__V(x);
  var this$7 = new ScalaJS.c.sci_Range$Inclusive().init___I__I__I(0, nN, 1);
  var this$8 = ScalaJS.m.sci_List$();
  var cbf = this$8.ReusableCBFInstance$2;
  var this$10 = ScalaJS.as.sci_List(ScalaJS.s.sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(this$7, cbf));
  var f = (function(shift$2, widthLine$1, split$1, nPascal$1) {
    return (function(p$2) {
      var p = ScalaJS.uI(p$2);
      return new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D((p - shift$2), ScalaJS.m.Lcom_grisoft_scala_util_GriMathUtil$().griNPletGauss__D__D__D__D__D((p - shift$2), widthLine$1, split$1, nPascal$1))
    })
  })(shift, widthLine, split, nPascal);
  ...
  if ((bf === ScalaJS.m.sci_List$().ReusableCBFInstance$2)) {
    ...
    var b = ScalaJS.s.sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(this$10, bf);
    var these = this$10;
    while ((!these.isEmpty__Z())) {
      var arg1$2 = these.head__O();
      b.$$plus$eq__O__scm_Builder(f(arg1$2));
...
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.makePoKoncam__sci_List__sci_List = (function(dd) {
  var a = this.getKof2Point__T2__T2__D(ScalaJS.as.T2(dd.head__O()), ScalaJS.as.T2(ScalaJS.s.sc_LinearSeqOptimized$class__last__sc_LinearSeqOptimized__O(dd)));
  var c = this.getShift2Point__T2__T2__D(ScalaJS.as.T2(dd.head__O()), ScalaJS.as.T2(ScalaJS.s.sc_LinearSeqOptimized$class__last__sc_LinearSeqOptimized__O(dd)));
  var f = (function(a$1, c$1) {
    return (function(aa$2) {
      var aa = ScalaJS.as.T2(aa$2);
      return new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D(aa.$$und1$mcD$sp__D(), (aa.$$und2$mcD$sp__D() - ((a$1 * aa.$$und1$mcD$sp__D()) + c$1)))
    })
  })(a, c);
  var this$1 = ScalaJS.m.sci_List$();
  var bf = this$1.ReusableCBFInstance$2;
...
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.griNPletLorenzPick__I__D__D__D__D__sci_List = (function(nN, shift, widthLine, split, nPascal) {
  var this$4 = new ScalaJS.c.sci_Range$Inclusive().init___I__I__I(0, nN, 1);
  var this$5 = ScalaJS.m.sci_List$();
  var cbf = this$5.ReusableCBFInstance$2;
  var this$7 = ScalaJS.as.sci_List(ScalaJS.s.sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(this$4, cbf));
  var f = (function(shift$5, widthLine$4, split$4, nPascal$4) {
    return (function(p$2) {
      var p = ScalaJS.uI(p$2);
      return new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D((p - shift$5), ScalaJS.m.Lcom_grisoft_scala_util_GriMathUtil$().griNPletLorenzPick__D__D__D__D__D((p - shift$5), widthLine$4, split$4, nPascal$4))
    })
  })(shift, widthLine, split, nPascal);
  var this$6 = ScalaJS.m.sci_List$();
  var bf = this$6.ReusableCBFInstance$2;
...
ScalaJS.d.Lcom_grisoft_scala_util_CsvUtils$ = new ScalaJS.ClassTypeData({
  Lcom_grisoft_scala_util_CsvUtils$: 0
}, false, "com.grisoft.scala.util.CsvUtils$", {
  Lcom_grisoft_scala_util_CsvUtils$: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$.prototype.$classData = ScalaJS.d.Lcom_grisoft_scala_util_CsvUtils$;
ScalaJS.n.Lcom_grisoft_scala_util_CsvUtils$ = (void 0);
ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$ = (function() {
  if ((!ScalaJS.n.Lcom_grisoft_scala_util_CsvUtils$)) {
    ScalaJS.n.Lcom_grisoft_scala_util_CsvUtils$ = new ScalaJS.c.Lcom_grisoft_scala_util_CsvUtils$().init___()
  };
  return ScalaJS.n.Lcom_grisoft_scala_util_CsvUtils$
});
/** @constructor */
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$ = (function() {
  ScalaJS.c.O.call(this);
  this.log2$1 = 0.0;
  this.sqpi$1 = 0.0;
  this.pascalMap$1 = null;
  this.bitmap$0$1 = false
});
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype.constructor = ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$;
/** @constructor */
ScalaJS.h.Lcom_grisoft_scala_util_GriMathUtil$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_scala_util_GriMathUtil$.prototype = ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype;
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype.init___ = (function() {
  ScalaJS.n.Lcom_grisoft_scala_util_GriMathUtil$ = this;
  this.sqpi$1 = ScalaJS.uD(ScalaJS.g["Math"]["sqrt"](3.141592653589793));
  this.pascalMap$1 = ScalaJS.as.sci_Map(ScalaJS.m.s_Predef$().Map$2.apply__sc_Seq__sc_GenMap(ScalaJS.m.sci_Nil$()));
  return this
});
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype.griLorenzPick__D__D__D = (function(x, a) {
  var kof = (1.0 / (3.141592653589793 * a));
  return (kof / (1.0 + ((x * x) / (a * a))))
});
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype.getPaskalTreangleKof__I__I__I = (function(row, col) {
  var ret = 0;
  var s = ((row + "-") + col);
  var x1 = this.pascalMap$1.get__O__s_Option(s);
  if (ScalaJS.is.s_Some(x1)) {
    var x2 = ScalaJS.as.s_Some(x1);
    var a = ScalaJS.uI(x2.x$2);
    ret = a
  } else {
    var x = ScalaJS.m.s_None$();
    if ((x === x1)) {
      ret = this.getPaskalTreangleKofRecu__I__I__I(row, col);
      var jsx$1 = this.pascalMap$1;
      var y = ret;
      this.pascalMap$1 = jsx$1.$$plus__T2__sci_Map(new ScalaJS.c.T2().init___O__O(s, y))
    } else {
      throw new ScalaJS.c.s_MatchError().init___O(x1)
    }
  };
...
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype.griGaussPick__D__D__D = (function(x, a) {
  var kof = (1.0 / (a * this.sqpi$1));
  var x$1 = (((-x) * x) / (a * a));
  return (kof * ScalaJS.uD(ScalaJS.g["Math"]["exp"](x$1)))
});
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype.griGauss__D__D__D = (function(x, a) {
  var kof = (2.0 / (((a * a) * a) * this.sqpi$1));
  var x$1 = (((-x) * x) / (a * a));
  return ((kof * x) * ScalaJS.uD(ScalaJS.g["Math"]["exp"](x$1)))
});
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype.griNPletLorenzPick__D__D__D__D__D = (function(x, widthLine, split, nPascal) {
  var elem$1 = 0.0;
  elem$1 = 0.0;
  var nPas = (nPascal | 0);
  var isEmpty$4 = (nPas < 0);
  var numRangeElements$4 = (isEmpty$4 ? 0 : ((nPas > 2147483646) ? (-1) : ((1 + nPas) | 0)));
  var lastElement$4 = (isEmpty$4 ? (-1) : nPas);
  var terminalElement$4 = ((1 + lastElement$4) | 0);
  if ((numRangeElements$4 < 0)) {
    ScalaJS.m.sci_Range$().scala$collection$immutable$Range$$fail__I__I__I__Z__sr_Nothing$(0, nPas, 1, true)
  };
  var i = 0;
  var count = 0;
  while ((i !== terminalElement$4)) {
    var v1 = i;
    var xx = (x + (v1 * split));
    elem$1 = (elem$1 + (ScalaJS.m.Lcom_grisoft_scala_util_GriMathUtil$().getPaskalTreangleKof__I__I__I(nPas, v1) * ScalaJS.m.Lcom_grisoft_scala_util_GriMathUtil$().griLorenzPick__D__D__D(xx, widthLine)));
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  };
  return elem$1
});
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype.griNPletGauss__D__D__D__D__D = (function(x, widthLine, split, nPascal) {
  var elem$1 = 0.0;
  elem$1 = 0.0;
  var nPas = (nPascal | 0);
  var isEmpty$4 = (nPas < 0);
  ...
  while ((i !== terminalElement$4)) {
    var v1 = i;
    var xx = (x + (v1 * split));
    elem$1 = (elem$1 + (ScalaJS.m.Lcom_grisoft_scala_util_GriMathUtil$().getPaskalTreangleKof__I__I__I(nPas, v1) * ScalaJS.m.Lcom_grisoft_scala_util_GriMathUtil$().griGauss__D__D__D(xx, widthLine)));
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  };
  return elem$1
});
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype.griNPletLorenz__D__D__D__D__D = (function(x, widthLine, split, nPascal) {
  var elem$1 = 0.0;
  elem$1 = 0.0;
  var nPas = (nPascal | 0);
  var isEmpty$4 = (nPas < 0);
  ...
  while ((i !== terminalElement$4)) {
    var v1 = i;
    var xx = (x + (v1 * split));
    elem$1 = (elem$1 + (ScalaJS.m.Lcom_grisoft_scala_util_GriMathUtil$().getPaskalTreangleKof__I__I__I(nPas, v1) * ScalaJS.m.Lcom_grisoft_scala_util_GriMathUtil$().griLorenz__D__D__D(xx, widthLine)));
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  };
  return elem$1
});
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype.griNPletGaussPick__D__D__D__D__D = (function(x, widthLine, split, nPascal) {
  var elem$1 = 0.0;
  elem$1 = 0.0;
  var nPas = (nPascal | 0);
  var isEmpty$4 = (nPas < 0);
  ...
  while ((i !== terminalElement$4)) {
    var v1 = i;
    var xx = (x + (v1 * split));
    elem$1 = (elem$1 + (ScalaJS.m.Lcom_grisoft_scala_util_GriMathUtil$().getPaskalTreangleKof__I__I__I(nPas, v1) * ScalaJS.m.Lcom_grisoft_scala_util_GriMathUtil$().griGaussPick__D__D__D(xx, widthLine)));
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  };
  return elem$1
});
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype.getPaskalTreangleKofRecu__I__I__I = (function(row, col) {
  return (((row < 0) || (col < 0)) ? 0 : (((row === 0) || (row === col)) ? 1 : ((this.getPaskalTreangleKof__I__I__I((((-1) + row) | 0), (((-1) + col) | 0)) + this.getPaskalTreangleKof__I__I__I((((-1) + row) | 0), col)) | 0)))
});
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype.griLorenz__D__D__D = (function(x, a) {
  var kof = (2.0 / (((3.141592653589793 * a) * a) * a));
  var sd = (1.0 + ((x * x) / (a * a)));
  return ((kof * x) / (sd * sd))
});
ScalaJS.d.Lcom_grisoft_scala_util_GriMathUtil$ = new ScalaJS.ClassTypeData({
  Lcom_grisoft_scala_util_GriMathUtil$: 0
}, false, "com.grisoft.scala.util.GriMathUtil$", {
  Lcom_grisoft_scala_util_GriMathUtil$: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$.prototype.$classData = ScalaJS.d.Lcom_grisoft_scala_util_GriMathUtil$;
ScalaJS.n.Lcom_grisoft_scala_util_GriMathUtil$ = (void 0);
ScalaJS.m.Lcom_grisoft_scala_util_GriMathUtil$ = (function() {
  if ((!ScalaJS.n.Lcom_grisoft_scala_util_GriMathUtil$)) {
    ScalaJS.n.Lcom_grisoft_scala_util_GriMathUtil$ = new ScalaJS.c.Lcom_grisoft_scala_util_GriMathUtil$().init___()
  };
  return ScalaJS.n.Lcom_grisoft_scala_util_GriMathUtil$
});
/** @constructor */
ScalaJS.c.Lcom_grisoft_scala_util_Point2DGri = (function() {
  ScalaJS.c.O.call(this);
  this.x$1 = 0.0;
  this.y$1 = 0.0
});
ScalaJS.c.Lcom_grisoft_scala_util_Point2DGri.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_scala_util_Point2DGri.prototype.constructor = ScalaJS.c.Lcom_grisoft_scala_util_Point2DGri;
/** @constructor */
ScalaJS.h.Lcom_grisoft_scala_util_Point2DGri = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_scala_util_Point2DGri.prototype = ScalaJS.c.Lcom_grisoft_scala_util_Point2DGri.prototype;
ScalaJS.c.Lcom_grisoft_scala_util_Point2DGri.prototype.toString__T = (function() {
  return ((("x=" + this.x$1) + " y=") + this.y$1)
});
ScalaJS.c.Lcom_grisoft_scala_util_Point2DGri.prototype.init___D__D = (function(x, y) {
  this.x$1 = x;
  this.y$1 = y;
  return this
});
ScalaJS.is.Lcom_grisoft_scala_util_Point2DGri = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_grisoft_scala_util_Point2DGri)))
});
ScalaJS.as.Lcom_grisoft_scala_util_Point2DGri = (function(obj) {
  return ((ScalaJS.is.Lcom_grisoft_scala_util_Point2DGri(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.grisoft.scala.util.Point2DGri"))
});
ScalaJS.isArrayOf.Lcom_grisoft_scala_util_Point2DGri = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_grisoft_scala_util_Point2DGri)))
});
ScalaJS.asArrayOf.Lcom_grisoft_scala_util_Point2DGri = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_grisoft_scala_util_Point2DGri(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.grisoft.scala.util.Point2DGri;", depth))
});
ScalaJS.d.Lcom_grisoft_scala_util_Point2DGri = new ScalaJS.ClassTypeData({
  Lcom_grisoft_scala_util_Point2DGri: 0
}, false, "com.grisoft.scala.util.Point2DGri", {
  Lcom_grisoft_scala_util_Point2DGri: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_scala_util_Point2DGri.prototype.$classData = ScalaJS.d.Lcom_grisoft_scala_util_Point2DGri;
/** @constructor */
ScalaJS.c.Lcom_grisoft_scala_util_PointGri = (function() {
  ScalaJS.c.O.call(this);
  this.x$1 = 0;
  this.y$1 = 0
});
ScalaJS.c.Lcom_grisoft_scala_util_PointGri.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_scala_util_PointGri.prototype.constructor = ScalaJS.c.Lcom_grisoft_scala_util_PointGri;
/** @constructor */
ScalaJS.h.Lcom_grisoft_scala_util_PointGri = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_scala_util_PointGri.prototype = ScalaJS.c.Lcom_grisoft_scala_util_PointGri.prototype;
ScalaJS.c.Lcom_grisoft_scala_util_PointGri.prototype.init___I__I = (function(x, y) {
  this.x$1 = x;
  this.y$1 = y;
  return this
});
ScalaJS.c.Lcom_grisoft_scala_util_PointGri.prototype.toString__T = (function() {
  return ((("x=" + this.x$1) + " y=") + this.y$1)
});
ScalaJS.is.Lcom_grisoft_scala_util_PointGri = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_grisoft_scala_util_PointGri)))
});
ScalaJS.as.Lcom_grisoft_scala_util_PointGri = (function(obj) {
  return ((ScalaJS.is.Lcom_grisoft_scala_util_PointGri(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.grisoft.scala.util.PointGri"))
});
ScalaJS.isArrayOf.Lcom_grisoft_scala_util_PointGri = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_grisoft_scala_util_PointGri)))
});
ScalaJS.asArrayOf.Lcom_grisoft_scala_util_PointGri = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_grisoft_scala_util_PointGri(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.grisoft.scala.util.PointGri;", depth))
});
ScalaJS.d.Lcom_grisoft_scala_util_PointGri = new ScalaJS.ClassTypeData({
  Lcom_grisoft_scala_util_PointGri: 0
}, false, "com.grisoft.scala.util.PointGri", {
  Lcom_grisoft_scala_util_PointGri: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_scala_util_PointGri.prototype.$classData = ScalaJS.d.Lcom_grisoft_scala_util_PointGri;
/** @constructor */
ScalaJS.c.Lcom_grisoft_scala_util_Rectangle2DGri = (function() {
  ScalaJS.c.O.call(this);
  this.x$1 = 0.0;
  this.y$1 = 0.0;
  this.w$1 = 0.0;
...
ScalaJS.c.Lcom_grisoft_scala_util_Rectangle2DGri.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_scala_util_Rectangle2DGri.prototype.constructor = ScalaJS.c.Lcom_grisoft_scala_util_Rectangle2DGri;
/** @constructor */
ScalaJS.h.Lcom_grisoft_scala_util_Rectangle2DGri = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_scala_util_Rectangle2DGri.prototype = ScalaJS.c.Lcom_grisoft_scala_util_Rectangle2DGri.prototype;
ScalaJS.c.Lcom_grisoft_scala_util_Rectangle2DGri.prototype.init___D__D__D__D = (function(x, y, w, h) {
  this.x$1 = x;
  this.y$1 = y;
  this.w$1 = w;
  this.h$1 = h;
...
ScalaJS.c.Lcom_grisoft_scala_util_Rectangle2DGri.prototype.toString__T = (function() {
  return ((((((("x=" + this.x$1) + " y=") + this.y$1) + " w=") + this.w$1) + " h=") + this.h$1)
});
ScalaJS.d.Lcom_grisoft_scala_util_Rectangle2DGri = new ScalaJS.ClassTypeData({
  Lcom_grisoft_scala_util_Rectangle2DGri: 0
}, false, "com.grisoft.scala.util.Rectangle2DGri", {
  Lcom_grisoft_scala_util_Rectangle2DGri: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_scala_util_Rectangle2DGri.prototype.$classData = ScalaJS.d.Lcom_grisoft_scala_util_Rectangle2DGri;
/** @constructor */
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivDFTButtons = (function() {
  ScalaJS.c.O.call(this);
  this.div1$1 = null;
  this.numPoints$1 = null;
  this.numKof$1 = null;
  this.fieldset$1 = null
});
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivDFTButtons.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivDFTButtons.prototype.constructor = ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivDFTButtons;
/** @constructor */
ScalaJS.h.Lcom_grisoft_webapp_scala_esr_DivDFTButtons = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_webapp_scala_esr_DivDFTButtons.prototype = ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivDFTButtons.prototype;
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivDFTButtons.prototype.init___Lorg_scalajs_dom_raw_HTMLDivElement = (function(div1) {
  this.div1$1 = div1;
  this.numPoints$1 = null;
  this.numKof$1 = null;
  this.numPoints$1 = ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldSpinner__I__I__I__I__Lorg_scalajs_dom_raw_HTMLInputElement(50, 2000, 50, 100);
  this.numKof$1 = ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldDouble__D__Lorg_scalajs_dom_raw_HTMLInputElement(2.0);
  this.fieldset$1 = ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldset__T__Lorg_scalajs_dom_raw_HTMLFieldSetElement("Discrete Fourier transform");
  div1["appendChild"](this.fieldset$1);
  this.fieldset$1["appendChild"](ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldText__T__Lorg_scalajs_dom_raw_Text(" N points:"));
  this.fieldset$1["appendChild"](this.numPoints$1);
  this.fieldset$1["appendChild"](ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldText__T__Lorg_scalajs_dom_raw_Text(" coeff:"));
  this.fieldset$1["appendChild"](this.numKof$1);
  this.fieldset$1["appendChild"](ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldText__T__Lorg_scalajs_dom_raw_Text("SUM f*exp(-2*PI*coeff*i/N)"));
  return this
});
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivDFTButtons.prototype.getSimParams__T2 = (function() {
  var jsx$1 = ScalaJS.uI(this.numPoints$1["valueAsNumber"]);
  var this$2 = new ScalaJS.c.sci_StringOps().init___T(ScalaJS.as.T(this.numKof$1["value"]));
  return new ScalaJS.c.s_Tuple2$mcID$sp().init___I__D(jsx$1, ScalaJS.m.jl_Double$().parseDouble__T__D(this$2.repr$1))
});
ScalaJS.d.Lcom_grisoft_webapp_scala_esr_DivDFTButtons = new ScalaJS.ClassTypeData({
  Lcom_grisoft_webapp_scala_esr_DivDFTButtons: 0
}, false, "com.grisoft.webapp.scala.esr.DivDFTButtons", {
  Lcom_grisoft_webapp_scala_esr_DivDFTButtons: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivDFTButtons.prototype.$classData = ScalaJS.d.Lcom_grisoft_webapp_scala_esr_DivDFTButtons;
/** @constructor */
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivHistogr = (function() {
  ScalaJS.c.O.call(this);
  this.div1$1 = null;
  this.buttonShow$1 = null;
  this.buttonFlipX$1 = null;
  this.buttonFlipY$1 = null;
  this.buttonSetZero$1 = null;
  this.buttonZeroByTheEndPoints$1 = null;
  this.buttonSearchZero$1 = null;
  this.canvas$1 = null;
  this.tableTwoCols$1 = null;
  this.panelHistogr$1 = null;
  this.txtarea$1 = null;
  this.br$1 = null;
  this.br1$1 = null
});
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivHistogr.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivHistogr.prototype.constructor = ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivHistogr;
/** @constructor */
ScalaJS.h.Lcom_grisoft_webapp_scala_esr_DivHistogr = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_webapp_scala_esr_DivHistogr.prototype = ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivHistogr.prototype;
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivHistogr.prototype.init___Lorg_scalajs_dom_raw_HTMLDivElement = (function(div1) {
  this.div1$1 = div1;
  this.buttonShow$1 = null;
  this.buttonFlipX$1 = null;
  this.buttonFlipY$1 = null;
  ...
  this.buttonZeroByTheEndPoints$1 = null;
  this.buttonSearchZero$1 = null;
  this.canvas$1 = ScalaJS.g["document"]["createElement"]("canvas");
  this.canvas$1["width"] = 500;
  this.canvas$1["height"] = 300;
  this.tableTwoCols$1 = new ScalaJS.c.Lcom_grisoft_panels_TableTwoCols().init___();
  this.panelHistogr$1 = new ScalaJS.c.Lcom_grisoft_scala_histogram_panel_PanelHistogr().init___Lorg_scalajs_dom_raw_HTMLCanvasElement(this.canvas$1);
  this.txtarea$1 = ScalaJS.g["document"]["createElement"]("textarea");
  this.txtarea$1["cols"] = 44;
  this.txtarea$1["rows"] = 15;
  this.initButtons__V();
  this.br$1 = ScalaJS.g["document"]["createElement"]("br");
  this.br1$1 = ScalaJS.g["document"]["createElement"]("br");
  div1["appendChild"](this.tableTwoCols$1.tableMain$1);
  this.tableTwoCols$1.tablecellLeft$1["appendChild"](this.canvas$1);
  this.tableTwoCols$1.tablecellRight$1["appendChild"](this.buttonShow$1);
  this.tableTwoCols$1.tablecellRight$1["appendChild"](this.buttonSearchZero$1);
  this.tableTwoCols$1.tablecellRight$1["appendChild"](this.buttonSetZero$1);
  this.tableTwoCols$1.tablecellRight$1["appendChild"](this.br1$1);
  this.tableTwoCols$1.tablecellRight$1["appendChild"](this.buttonFlipX$1);
  this.tableTwoCols$1.tablecellRight$1["appendChild"](this.buttonFlipY$1);
  this.tableTwoCols$1.tablecellRight$1["appendChild"](this.buttonZeroByTheEndPoints$1);
  this.tableTwoCols$1.tablecellRight$1["appendChild"](this.br$1);
  this.tableTwoCols$1.tablecellRight$1["appendChild"](this.txtarea$1);
  var qual$1 = this.buttonShow$1;
  var x$2 = (function(arg$outer) {
    return (function(e$2) {
      var data = ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().loadFromString__T__T__sci_List(ScalaJS.as.T(arg$outer.txtarea$1["value"]), ",");
      var griHistogram = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram().init___sci_List(data);
      var this$1 = arg$outer.panelHistogr$1;
      this$1.histogramFields$1.setOneGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V(griHistogram);
      arg$outer.panelHistogr$1.paint__V()
    })
  })(this);
  qual$1["addEventListener"]("click", x$2);
  var qual$2 = this.buttonSearchZero$1;
  var x$5 = (function(arg$outer$1) {
    return (function(e$2$1) {
      var this$2 = arg$outer$1.panelHistogr$1.histogramFields$1.histList$1;
      ScalaJS.as.Lcom_grisoft_scala_histogram_model_GriHistogram(ScalaJS.s.sc_LinearSeqOptimized$class__apply__sc_LinearSeqOptimized__I__O(this$2, 0)).makeZeroByIntegral__V();
      var this$3 = arg$outer$1.panelHistogr$1;
      var this$4 = this$3.histogramFields$1;
      this$4.fieldRec$1 = this$4.getMaxMinRec__Lcom_grisoft_scala_util_Rectangle2DGri();
      arg$outer$1.panelHistogr$1.paint__V();
      arg$outer$1.txtarea$1["value"] = ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().getStringFromData__T__sci_List__T(",", arg$outer$1.panelHistogr$1.getData__I__sci_List(0))
    })
  })(this);
  qual$2["addEventListener"]("click", x$5);
  var qual$3 = this.buttonZeroByTheEndPoints$1;
  var x$8 = (function(arg$outer$2) {
    return (function(e$2$2) {
      var this$5 = arg$outer$2.panelHistogr$1.histogramFields$1.histList$1;
      ScalaJS.as.Lcom_grisoft_scala_histogram_model_GriHistogram(ScalaJS.s.sc_LinearSeqOptimized$class__apply__sc_LinearSeqOptimized__I__O(this$5, 0)).makePoKoncam__V();
      var this$6 = arg$outer$2.panelHistogr$1;
      var this$7 = this$6.histogramFields$1;
      this$7.fieldRec$1 = this$7.getMaxMinRec__Lcom_grisoft_scala_util_Rectangle2DGri();
      arg$outer$2.panelHistogr$1.paint__V();
      arg$outer$2.txtarea$1["value"] = ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().getStringFromData__T__sci_List__T(",", arg$outer$2.panelHistogr$1.getData__I__sci_List(0))
    })
  })(this);
  qual$3["addEventListener"]("click", x$8);
  var qual$4 = this.buttonFlipX$1;
  var x$11 = (function(arg$outer$3) {
    return (function(e$2$3) {
      var this$8 = arg$outer$3.panelHistogr$1.histogramFields$1.histList$1;
      ScalaJS.as.Lcom_grisoft_scala_histogram_model_GriHistogram(ScalaJS.s.sc_LinearSeqOptimized$class__apply__sc_LinearSeqOptimized__I__O(this$8, 0)).setMulMinusX__V();
      var this$9 = arg$outer$3.panelHistogr$1;
      var this$10 = this$9.histogramFields$1;
      this$10.fieldRec$1 = this$10.getMaxMinRec__Lcom_grisoft_scala_util_Rectangle2DGri();
      arg$outer$3.panelHistogr$1.paint__V();
      arg$outer$3.txtarea$1["value"] = ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().getStringFromData__T__sci_List__T(",", arg$outer$3.panelHistogr$1.getData__I__sci_List(0))
    })
  })(this);
  qual$4["addEventListener"]("click", x$11);
  var qual$5 = this.buttonFlipY$1;
  var x$14 = (function(arg$outer$4) {
    return (function(e$2$4) {
      var this$11 = arg$outer$4.panelHistogr$1.histogramFields$1.histList$1;
      ScalaJS.as.Lcom_grisoft_scala_histogram_model_GriHistogram(ScalaJS.s.sc_LinearSeqOptimized$class__apply__sc_LinearSeqOptimized__I__O(this$11, 0)).setMulMinusY__V();
      var this$12 = arg$outer$4.panelHistogr$1;
      var this$13 = this$12.histogramFields$1;
      this$13.fieldRec$1 = this$13.getMaxMinRec__Lcom_grisoft_scala_util_Rectangle2DGri();
      arg$outer$4.panelHistogr$1.paint__V();
      arg$outer$4.txtarea$1["value"] = ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().getStringFromData__T__sci_List__T(",", arg$outer$4.panelHistogr$1.getData__I__sci_List(0))
    })
  })(this);
  qual$5["addEventListener"]("click", x$14);
  return this
});
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivHistogr.prototype.initButtons__V = (function() {
  this.buttonShow$1 = ScalaJS.g["document"]["createElement"]("button");
  this.buttonShow$1["name"] = "Show";
  this.buttonShow$1["value"] = "Show";
  this.buttonShow$1["innerHTML"] = "Show histogram";
  this.buttonFlipX$1 = ScalaJS.g["document"]["createElement"]("button");
  this.buttonFlipX$1["name"] = "FlipX";
  this.buttonFlipX$1["value"] = "FlipX";
  this.buttonFlipX$1["innerHTML"] = "Flip X";
  this.buttonFlipY$1 = ScalaJS.g["document"]["createElement"]("button");
  this.buttonFlipY$1["name"] = "FlipY";
  this.buttonFlipY$1["value"] = "FlipY";
  this.buttonFlipY$1["innerHTML"] = "Flip Y";
  this.buttonSetZero$1 = ScalaJS.g["document"]["createElement"]("button");
  this.buttonSetZero$1["name"] = "SetZero";
  this.buttonSetZero$1["value"] = "SetZero";
  this.buttonSetZero$1["innerHTML"] = "Set Zero XY";
  this.buttonZeroByTheEndPoints$1 = ScalaJS.g["document"]["createElement"]("button");
  this.buttonZeroByTheEndPoints$1["name"] = "ZeroByTheEndPoints";
  this.buttonZeroByTheEndPoints$1["value"] = "ZeroByTheEndPoints";
  this.buttonZeroByTheEndPoints$1["innerHTML"] = "Set Zero at the ends";
  this.buttonSearchZero$1 = ScalaJS.g["document"]["createElement"]("button");
  this.buttonSearchZero$1["name"] = "SearchZero";
  this.buttonSearchZero$1["value"] = "SearchZero";
  this.buttonSearchZero$1["innerHTML"] = "Search Zero by Y"
});
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivHistogr.prototype.setOneGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V = (function(histogram) {
  var this$1 = this.panelHistogr$1;
  this$1.histogramFields$1.setOneGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V(histogram);
  this.txtarea$1["value"] = ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().getStringFromData__T__sci_List__T(",", this.panelHistogr$1.getData__I__sci_List(0))
});
ScalaJS.d.Lcom_grisoft_webapp_scala_esr_DivHistogr = new ScalaJS.ClassTypeData({
  Lcom_grisoft_webapp_scala_esr_DivHistogr: 0
}, false, "com.grisoft.webapp.scala.esr.DivHistogr", {
  Lcom_grisoft_webapp_scala_esr_DivHistogr: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivHistogr.prototype.$classData = ScalaJS.d.Lcom_grisoft_webapp_scala_esr_DivHistogr;
/** @constructor */
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivSimButtons = (function() {
  ScalaJS.c.O.call(this);
  this.div1$1 = null;
  this.numPoints$1 = null;
  this.numShift$1 = null;
  this.numWidth$1 = null;
  this.numSplit$1 = null;
  this.numMultypl$1 = null;
  this.fieldset$1 = null
});
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivSimButtons.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivSimButtons.prototype.constructor = ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivSimButtons;
/** @constructor */
ScalaJS.h.Lcom_grisoft_webapp_scala_esr_DivSimButtons = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_webapp_scala_esr_DivSimButtons.prototype = ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivSimButtons.prototype;
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivSimButtons.prototype.init___Lorg_scalajs_dom_raw_HTMLDivElement = (function(div1) {
  this.div1$1 = div1;
  this.numPoints$1 = null;
  this.numShift$1 = null;
  this.numWidth$1 = null;
  this.numSplit$1 = null;
  this.numMultypl$1 = null;
  this.numPoints$1 = ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldSpinner__I__I__I__I__Lorg_scalajs_dom_raw_HTMLInputElement(100, 1000, 100, 1000);
  this.numShift$1 = ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldSpinner__I__I__I__I__Lorg_scalajs_dom_raw_HTMLInputElement(10, 1000, 10, 500);
  this.numWidth$1 = ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldDouble__D__Lorg_scalajs_dom_raw_HTMLInputElement(10.5);
  this.numSplit$1 = ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldSpinner__I__I__I__I__Lorg_scalajs_dom_raw_HTMLInputElement(10, 1000, 5, 30);
  this.numMultypl$1 = ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldSpinner__I__I__I__I__Lorg_scalajs_dom_raw_HTMLInputElement(0, 40, 1, 2);
  this.fieldset$1 = ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldset__T__Lorg_scalajs_dom_raw_HTMLFieldSetElement("Simulation ESR");
  div1["appendChild"](this.fieldset$1);
  this.fieldset$1["appendChild"](ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldText__T__Lorg_scalajs_dom_raw_Text("N multipl:"));
  this.fieldset$1["appendChild"](this.numMultypl$1);
  this.fieldset$1["appendChild"](ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldText__T__Lorg_scalajs_dom_raw_Text("N points:"));
  this.fieldset$1["appendChild"](this.numPoints$1);
  this.fieldset$1["appendChild"](ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldText__T__Lorg_scalajs_dom_raw_Text("Shift:"));
  this.fieldset$1["appendChild"](this.numShift$1);
  this.fieldset$1["appendChild"](ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldText__T__Lorg_scalajs_dom_raw_Text("Width:"));
  this.fieldset$1["appendChild"](this.numWidth$1);
  this.fieldset$1["appendChild"](ScalaJS.m.Lcom_grisoft_panels_ElementsUtils$().makeFieldText__T__Lorg_scalajs_dom_raw_Text("Split:"));
  this.fieldset$1["appendChild"](this.numSplit$1);
  return this
});
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivSimButtons.prototype.getSimParams__T5 = (function() {
  var jsx$3 = ScalaJS.uI(this.numPoints$1["valueAsNumber"]);
  var this$2 = new ScalaJS.c.sci_StringOps().init___T(ScalaJS.as.T(this.numShift$1["value"]));
  var jsx$2 = ScalaJS.m.jl_Double$().parseDouble__T__D(this$2.repr$1);
  var this$5 = new ScalaJS.c.sci_StringOps().init___T(ScalaJS.as.T(this.numWidth$1["value"]));
  var jsx$1 = ScalaJS.m.jl_Double$().parseDouble__T__D(this$5.repr$1);
  var this$8 = new ScalaJS.c.sci_StringOps().init___T(ScalaJS.as.T(this.numSplit$1["value"]));
  return new ScalaJS.c.T5().init___O__O__O__O__O(jsx$3, jsx$2, jsx$1, ScalaJS.m.jl_Double$().parseDouble__T__D(this$8.repr$1), ScalaJS.uI(this.numMultypl$1["valueAsNumber"]))
});
ScalaJS.d.Lcom_grisoft_webapp_scala_esr_DivSimButtons = new ScalaJS.ClassTypeData({
  Lcom_grisoft_webapp_scala_esr_DivSimButtons: 0
}, false, "com.grisoft.webapp.scala.esr.DivSimButtons", {
  Lcom_grisoft_webapp_scala_esr_DivSimButtons: 1,
  O: 1
});
ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivSimButtons.prototype.$classData = ScalaJS.d.Lcom_grisoft_webapp_scala_esr_DivSimButtons;
/** @constructor */
...
ScalaJS.c.jl_Double$.prototype.doubleStrPat__p1__sjs_js_RegExp = (function() {
  return ((!this.bitmap$0$1) ? this.doubleStrPat$lzycompute__p1__sjs_js_RegExp() : this.doubleStrPat$1)
});
ScalaJS.c.jl_Double$.prototype.doubleStrPat$lzycompute__p1__sjs_js_RegExp = (function() {
  if ((!this.bitmap$0$1)) {
    this.doubleStrPat$1 = new ScalaJS.g["RegExp"]("^[\\x00-\\x20]*[+-]?(NaN|Infinity|(\\d+\\.?\\d*|\\.\\d+)([eE][+-]?\\d+)?)[fFdD]?[\\x00-\\x20]*$");
...
ScalaJS.c.jl_Double$.prototype.parseDouble__T__D = (function(s) {
  if (ScalaJS.uZ(this.doubleStrPat__p1__sjs_js_RegExp()["test"](s))) {
...
ScalaJS.c.jl_Math$.prototype.hypot__D__D__D = (function(a, b) {
  if (((((a < 0) ? (-a) : a) === Infinity) || (((b < 0) ? (-b) : b) === Infinity))) {
    return Infinity
  } else if (((a !== a) || (b !== b))) {
    return (NaN)
  } else if (((a === 0) && (b === 0))) {
    ...
    var t = (((x < y) ? x : y) / m);
    var a$1 = (1 + (t * t));
    return (m * ScalaJS.uD(ScalaJS.g["Math"]["sqrt"](a$1)))
  }
});
...
ScalaJS.c.jl_System$.prototype.nanoTime__J = (function() {
  return ScalaJS.m.sjsr_RuntimeLong$().fromDouble__D__sjsr_RuntimeLong((1000000 * ScalaJS.uD((0, this.getHighPrecisionTime$1)())))
});
...
/** @constructor */
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$ = (function() {
  ScalaJS.c.O.call(this);
  this.divButttons$1 = null;
  this.divDFTButttons$1 = null;
  this.divSimButtons$1 = null;
  this.divDFTElemButtons$1 = null;
  this.div1$1 = null;
  this.divHistogr$1 = null;
  this.divHistogr2$1 = null;
  this.divHistogr3$1 = null
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.constructor = ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$;
/** @constructor */
ScalaJS.h.Lcom_grisoft_webapp_esr_GriEsrCalcApp$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype = ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype;
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.$$js$exported$meth$makeLorenzPick__O = (function() {
  this.makeLorenzPick__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.init___ = (function() {
  ScalaJS.n.Lcom_grisoft_webapp_esr_GriEsrCalcApp$ = this;
  this.divButttons$1 = null;
  this.divDFTButttons$1 = null;
  this.divSimButtons$1 = null;
  this.divDFTElemButtons$1 = null;
...
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.makeSubstruct__V = (function() {
  var data0 = this.divHistogr$1.panelHistogr$1.getData__I__sci_List(0);
  var data1 = this.divHistogr2$1.panelHistogr$1.getData__I__sci_List(0);
  var data3 = ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().makePlus__sci_List__sci_List__D__D__sci_List(data0, data1, (-1.0), 0.0);
  var griHistogram = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram().init___sci_List(data3);
  this.divHistogr3$1.setOneGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V(griHistogram);
  var this$1 = this.divHistogr3$1;
  this$1.panelHistogr$1.paint__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.$$js$exported$meth$makeSubstruct__O = (function() {
  this.makeSubstruct__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.makeSumma__V = (function() {
  var data0 = this.divHistogr$1.panelHistogr$1.getData__I__sci_List(0);
  var data1 = this.divHistogr2$1.panelHistogr$1.getData__I__sci_List(0);
  var data3 = ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().makePlus__sci_List__sci_List__D__D__sci_List(data0, data1, 1.0, 0.0);
  var griHistogram = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram().init___sci_List(data3);
...
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.makeLorenz__V = (function() {
  var params = this.divSimButtons$1.getSimParams__T5();
  var data = ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().griNPletGauss__I__D__D__D__I__sci_List(ScalaJS.uI(params.$$und1$1), ScalaJS.uD(params.$$und2$1), ScalaJS.uD(params.$$und3$1), ScalaJS.uD(params.$$und4$1), ScalaJS.uI(params.$$und5$1));
  var griHistogram = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram().init___sci_List(data);
  this.divHistogr$1.setOneGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V(griHistogram);
  var this$1 = this.divHistogr$1;
  this$1.panelHistogr$1.paint__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.makeDFT__V = (function() {
  var data0 = this.divHistogr$1.panelHistogr$1.getData__I__sci_List(0);
  var f = (function(a1$2) {
    var a1 = ScalaJS.as.T2(a1$2);
    return a1.$$und2$mcD$sp__D()
  });
  var this$1 = ScalaJS.m.sci_List$();
  var bf = this$1.ReusableCBFInstance$2;
  if ((bf === ScalaJS.m.sci_List$().ReusableCBFInstance$2)) {
    if ((data0 === ScalaJS.m.sci_Nil$())) {
      var jsx$1 = ScalaJS.m.sci_Nil$()
    } else {
      var arg1 = data0.head__O();
      var h = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(f(arg1), ScalaJS.m.sci_Nil$());
      var t = h;
      var rest = data0.tail__sci_List();
      while ((rest !== ScalaJS.m.sci_Nil$())) {
        var arg1$1 = rest.head__O();
        var nx = new ScalaJS.c.sci_$colon$colon().init___O__sci_List(f(arg1$1), ScalaJS.m.sci_Nil$());
        t.tl$5 = nx;
    ...
    var b = ScalaJS.s.sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(data0, bf);
    var these = data0;
    while ((!these.isEmpty__Z())) {
      var arg1$2 = these.head__O();
      b.$$plus$eq__O__scm_Builder(f(arg1$2));
  ...
  var liData = ScalaJS.as.sci_List(jsx$1);
  var params = this.divDFTElemButtons$1.getSimParams__T2();
  var li = ScalaJS.m.Lcom_grisoft_scala_grimath_GriDFT$().dft__sci_List__I__D__sci_List(liData, params.$$und1$mcI$sp__I(), params.$$und2$mcD$sp__D());
  var ii = new ScalaJS.c.sr_IntRef().init___I((-1));
  var this$6 = li.reverse__sci_List();
  var f$1 = (function(ii$1) {
    return (function(s$2) {
      var s = ScalaJS.as.Lcom_grisoft_scala_grimath_ComplexGri(s$2);
      ii$1.elem$1 = ((1 + ii$1.elem$1) | 0);
      return new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D(ii$1.elem$1, ScalaJS.m.jl_Math$().hypot__D__D__D(s.re$1, s.im$1))
    })
  })(ii);
  var this$5 = ScalaJS.m.sci_List$();
  var bf$1 = this$5.ReusableCBFInstance$2;
  if ((bf$1 === ScalaJS.m.sci_List$().ReusableCBFInstance$2)) {
    if ((this$6 === ScalaJS.m.sci_Nil$())) {
      var jsx$2 = ScalaJS.m.sci_Nil$()
    } else {
    ...
    var b$1 = ScalaJS.s.sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(this$6, bf$1);
    var these$1 = this$6;
    while ((!these$1.isEmpty__Z())) {
      var arg1$5 = these$1.head__O();
      b$1.$$plus$eq__O__scm_Builder(f$1(arg1$5));
  ...
  var data1 = ScalaJS.as.sci_List(jsx$2);
  var griHistogram = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram().init___sci_List(data1);
  this.divHistogr2$1.setOneGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V(griHistogram);
  var this$9 = this.divHistogr2$1;
  this$9.panelHistogr$1.paint__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.$$js$exported$meth$makeGauss__O = (function() {
  this.makeGauss__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.$$js$exported$meth$makeCopy__O = (function() {
  this.makeCopy__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.getTestData__sci_List = (function() {
  ScalaJS.m.sci_IndexedSeq$();
  ScalaJS.m.sc_IndexedSeq$().ReusableCBF$6;
  ScalaJS.m.sci_IndexedSeq$();
  ScalaJS.m.sci_Vector$();
  var b$1 = new ScalaJS.c.sci_VectorBuilder().init___();
  var i = 1;
  var count = 0;
  while ((i !== 201)) {
    var arg1 = i;
    var a = (0.1 * arg1);
    var elem = new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D((0.1 * arg1), ScalaJS.uD(ScalaJS.g["Math"]["sin"](a)));
    b$1.$$plus$eq__O__sci_VectorBuilder(elem);
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  };
  var this$8 = b$1.result__sci_Vector();
  var this$9 = ScalaJS.m.sci_List$();
  var cbf = this$9.ReusableCBFInstance$2;
  return ScalaJS.as.sci_List(ScalaJS.s.sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(this$8, cbf))
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.main__V = (function() {
  this.divButttons$1 = ScalaJS.g["document"]["getElementById"]("divbuttons");
  this.divSimButtons$1 = new ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivSimButtons().init___Lorg_scalajs_dom_raw_HTMLDivElement(this.divButttons$1);
  this.divDFTButttons$1 = ScalaJS.g["document"]["getElementById"]("divdft");
  this.divDFTElemButtons$1 = new ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivDFTButtons().init___Lorg_scalajs_dom_raw_HTMLDivElement(this.divDFTButttons$1);
  this.div1$1 = ScalaJS.g["document"]["getElementById"]("div1");
  this.divHistogr$1 = new ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivHistogr().init___Lorg_scalajs_dom_raw_HTMLDivElement(this.div1$1);
  var div2 = ScalaJS.g["document"]["getElementById"]("div2");
  this.divHistogr2$1 = new ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivHistogr().init___Lorg_scalajs_dom_raw_HTMLDivElement(div2);
  var div3 = ScalaJS.g["document"]["getElementById"]("div3");
  this.divHistogr3$1 = new ScalaJS.c.Lcom_grisoft_webapp_scala_esr_DivHistogr().init___Lorg_scalajs_dom_raw_HTMLDivElement(div3)
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.$$js$exported$meth$makeLorenz__O = (function() {
  this.makeLorenz__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.makeLorenzPick__V = (function() {
  var params = this.divSimButtons$1.getSimParams__T5();
  var data = ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().griNPletGaussPick__I__D__D__D__D__sci_List(ScalaJS.uI(params.$$und1$1), ScalaJS.uD(params.$$und2$1), ScalaJS.uD(params.$$und3$1), ScalaJS.uD(params.$$und4$1), ScalaJS.uI(params.$$und5$1));
  var griHistogram = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram().init___sci_List(data);
  this.divHistogr$1.setOneGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V(griHistogram);
  var this$1 = this.divHistogr$1;
  this$1.panelHistogr$1.paint__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.makeFirstIntegral__V = (function() {
  var data0 = this.divHistogr$1.panelHistogr$1.getData__I__sci_List(0);
  var griHistogram = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram().init___sci_List(ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().getIntegral__sci_List__sci_List(data0));
  this.divHistogr2$1.setOneGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V(griHistogram);
  var this$1 = this.divHistogr2$1;
  this$1.panelHistogr$1.paint__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.$$js$exported$meth$makeSumma__O = (function() {
  this.makeSumma__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.$$js$exported$meth$makeDFT__O = (function() {
  this.makeDFT__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.$$js$exported$meth$addClickedMessage__O = (function() {
  this.testGraphic__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.$$js$exported$meth$makeFirstIntegral__O = (function() {
  this.makeFirstIntegral__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.makeGauss__V = (function() {
  var params = this.divSimButtons$1.getSimParams__T5();
  var data = ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().griNPletLorenz__I__D__D__D__D__sci_List(ScalaJS.uI(params.$$und1$1), ScalaJS.uD(params.$$und2$1), ScalaJS.uD(params.$$und3$1), ScalaJS.uD(params.$$und4$1), ScalaJS.uI(params.$$und5$1));
  var griHistogram = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram().init___sci_List(data);
  this.divHistogr$1.setOneGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V(griHistogram);
  var this$1 = this.divHistogr$1;
  this$1.panelHistogr$1.paint__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.makeGaussPick__V = (function() {
  var params = this.divSimButtons$1.getSimParams__T5();
  var data = ScalaJS.m.Lcom_grisoft_scala_util_CsvUtils$().griNPletLorenzPick__I__D__D__D__D__sci_List(ScalaJS.uI(params.$$und1$1), ScalaJS.uD(params.$$und2$1), ScalaJS.uD(params.$$und3$1), ScalaJS.uD(params.$$und4$1), ScalaJS.uI(params.$$und5$1));
  var griHistogram = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram().init___sci_List(data);
  this.divHistogr$1.setOneGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V(griHistogram);
  var this$1 = this.divHistogr$1;
  this$1.panelHistogr$1.paint__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.testGraphic__V = (function() {
  var griHistogram = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram().init___sci_List(this.getTestData__sci_List());
  var x = ("griHistogram=" + griHistogram);
  var this$2 = ScalaJS.m.s_Console$();
  var this$3 = this$2.outVar$2;
  ScalaJS.as.Ljava_io_PrintStream(this$3.tl$1.get__O()).println__O__V(x);
  this.divHistogr$1.setOneGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V(griHistogram);
  var this$4 = this.divHistogr$1;
  this$4.panelHistogr$1.paint__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.makeCopy__V = (function() {
  var data0 = this.divHistogr$1.panelHistogr$1.getData__I__sci_List(0);
  var griHistogram = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram().init___sci_List(data0);
  this.divHistogr2$1.setOneGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V(griHistogram);
  var this$1 = this.divHistogr2$1;
  this$1.panelHistogr$1.paint__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.$$js$exported$meth$makeGaussPick__O = (function() {
  this.makeGaussPick__V()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype["makeDFT"] = (function() {
  return this.$$js$exported$meth$makeDFT__O()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype["makeSumma"] = (function() {
  return this.$$js$exported$meth$makeSumma__O()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype["makeSubstruct"] = (function() {
  return this.$$js$exported$meth$makeSubstruct__O()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype["makeCopy"] = (function() {
  return this.$$js$exported$meth$makeCopy__O()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype["makeFirstIntegral"] = (function() {
  return this.$$js$exported$meth$makeFirstIntegral__O()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype["makeLorenzPick"] = (function() {
  return this.$$js$exported$meth$makeLorenzPick__O()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype["makeGaussPick"] = (function() {
  return this.$$js$exported$meth$makeGaussPick__O()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype["makeLorenz"] = (function() {
  return this.$$js$exported$meth$makeLorenz__O()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype["makeGauss"] = (function() {
  return this.$$js$exported$meth$makeGauss__O()
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype["addClickedMessage"] = (function() {
  return this.$$js$exported$meth$addClickedMessage__O()
});
ScalaJS.d.Lcom_grisoft_webapp_esr_GriEsrCalcApp$ = new ScalaJS.ClassTypeData({
  Lcom_grisoft_webapp_esr_GriEsrCalcApp$: 0
}, false, "com.grisoft.webapp.esr.GriEsrCalcApp$", {
  Lcom_grisoft_webapp_esr_GriEsrCalcApp$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$.prototype.$classData = ScalaJS.d.Lcom_grisoft_webapp_esr_GriEsrCalcApp$;
ScalaJS.n.Lcom_grisoft_webapp_esr_GriEsrCalcApp$ = (void 0);
ScalaJS.m.Lcom_grisoft_webapp_esr_GriEsrCalcApp$ = (function() {
  if ((!ScalaJS.n.Lcom_grisoft_webapp_esr_GriEsrCalcApp$)) {
    ScalaJS.n.Lcom_grisoft_webapp_esr_GriEsrCalcApp$ = new ScalaJS.c.Lcom_grisoft_webapp_esr_GriEsrCalcApp$().init___()
  };
  return ScalaJS.n.Lcom_grisoft_webapp_esr_GriEsrCalcApp$
});
ScalaJS.e["GriEsr"] = ScalaJS.m.Lcom_grisoft_webapp_esr_GriEsrCalcApp$;
ScalaJS.e["com"] = (ScalaJS.e["com"] || {});
ScalaJS.e["com"]["grisoft"] = (ScalaJS.e["com"]["grisoft"] || {});
ScalaJS.e["com"]["grisoft"]["webapp"] = (ScalaJS.e["com"]["grisoft"]["webapp"] || {});
ScalaJS.e["com"]["grisoft"]["webapp"]["esr"] = (ScalaJS.e["com"]["grisoft"]["webapp"]["esr"] || {});
ScalaJS.e["com"]["grisoft"]["webapp"]["esr"]["GriEsrCalcApp"] = ScalaJS.m.Lcom_grisoft_webapp_esr_GriEsrCalcApp$;
/** @constructor */
ScalaJS.c.Ltutorial_webapp_GriEsrApp$ = (function() {
  ScalaJS.c.O.call(this);
  this.w$1 = 0;
  this.h$1 = 0;
  this.xy$1 = null;
...
ScalaJS.c.Ltutorial_webapp_GriEsrApp$.prototype = new ScalaJS.h.O();
ScalaJS.c.Ltutorial_webapp_GriEsrApp$.prototype.constructor = ScalaJS.c.Ltutorial_webapp_GriEsrApp$;
/** @constructor */
ScalaJS.h.Ltutorial_webapp_GriEsrApp$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Ltutorial_webapp_GriEsrApp$.prototype = ScalaJS.c.Ltutorial_webapp_GriEsrApp$.prototype;
ScalaJS.c.Ltutorial_webapp_GriEsrApp$.prototype.init___ = (function() {
  ScalaJS.n.Ltutorial_webapp_GriEsrApp$ = this;
  this.w$1 = 0;
  this.h$1 = 0;
  this.xy$1 = new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D(this.w$1, this.h$1);
  this.xy0$1 = new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D(this.w$1, this.h$1);
  this.ctx$1 = null;
  this.canvas$1 = null;
  return this
});
ScalaJS.c.Ltutorial_webapp_GriEsrApp$.prototype.getTestData1__sci_List = (function() {
  ScalaJS.m.sci_IndexedSeq$();
  ScalaJS.m.sc_IndexedSeq$().ReusableCBF$6;
  ScalaJS.m.sci_IndexedSeq$();
  ScalaJS.m.sci_Vector$();
  ...
  while ((i !== 201)) {
    var arg1 = i;
    var a = (0.01 * arg1);
    var elem = new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D((0.1 * arg1), (0.5 * ScalaJS.uD(ScalaJS.g["Math"]["sin"](a))));
    b$1.$$plus$eq__O__sci_VectorBuilder(elem);
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  };
...
ScalaJS.c.Ltutorial_webapp_GriEsrApp$.prototype.getTestData__sci_List = (function() {
  ScalaJS.m.sci_IndexedSeq$();
  ScalaJS.m.sc_IndexedSeq$().ReusableCBF$6;
  ScalaJS.m.sci_IndexedSeq$();
  ScalaJS.m.sci_Vector$();
...
ScalaJS.c.Ltutorial_webapp_GriEsrApp$.prototype.main__V = (function() {
  var this$2 = ScalaJS.m.s_Console$();
  var this$3 = this$2.outVar$2;
  ScalaJS.as.Ljava_io_PrintStream(this$3.tl$1.get__O()).println__O__V("main(): Unit =!!!!!");
  this.canvas$1 = ScalaJS.g["document"]["getElementById"]("canvas");
  this.ctx$1 = this.canvas$1["getContext"]("2d");
  this.xy0$1 = new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D(ScalaJS.uD(this.canvas$1["getBoundingClientRect"]()["left"]), ScalaJS.uD(this.canvas$1["getBoundingClientRect"]()["top"]));
  this.h$1 = ScalaJS.uI(this.canvas$1["height"]);
  this.w$1 = ScalaJS.uI(this.canvas$1["width"]);
  this.xy$1 = new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D(this.w$1, this.h$1);
  this.ctx$1["fillRect"](0.0, 0.0, ((this.w$1 / 2) | 0), ((this.h$1 / 2) | 0));
  this.ctx$1["beginPath"]();
  this.appendPar__Lorg_scalajs_dom_raw_Node__T__V(ScalaJS.g["document"]["body"], (((("Gri---!!!!!w=" + this.w$1) + " h=") + this.h$1) + "!!!!!!---"));
  this.appendPar__Lorg_scalajs_dom_raw_Node__T__V(ScalaJS.g["document"]["body"], ("Gri---xy0=" + this.xy0$1));
  this.canvas$1["onclick"] = (function(e$2) {
    ScalaJS.m.Ltutorial_webapp_GriEsrApp$().ctx$1["moveTo"]((ScalaJS.m.Ltutorial_webapp_GriEsrApp$().xy$1.$$und1$mcD$sp__D() - ScalaJS.m.Ltutorial_webapp_GriEsrApp$().xy0$1.$$und1$mcD$sp__D()), (ScalaJS.m.Ltutorial_webapp_GriEsrApp$().xy$1.$$und2$mcD$sp__D() - ScalaJS.m.Ltutorial_webapp_GriEsrApp$().xy0$1.$$und2$mcD$sp__D()));
    var x = ScalaJS.uD(e$2["clientX"]);
    var y = ScalaJS.uD(e$2["clientY"]);
    ScalaJS.m.Ltutorial_webapp_GriEsrApp$().ctx$1["fillRect"](x, y, 2.0, 2.0);
    ScalaJS.m.Ltutorial_webapp_GriEsrApp$().ctx$1["lineTo"]((x - ScalaJS.m.Ltutorial_webapp_GriEsrApp$().xy0$1.$$und1$mcD$sp__D()), (y - ScalaJS.m.Ltutorial_webapp_GriEsrApp$().xy0$1.$$und2$mcD$sp__D()));
    ScalaJS.m.Ltutorial_webapp_GriEsrApp$().ctx$1["closePath"]();
    ScalaJS.m.Ltutorial_webapp_GriEsrApp$().ctx$1["stroke"]();
    ScalaJS.m.Ltutorial_webapp_GriEsrApp$().xy$1 = new ScalaJS.c.s_Tuple2$mcDD$sp().init___D__D(x, y)
  })
});
ScalaJS.c.Ltutorial_webapp_GriEsrApp$.prototype.$$js$exported$meth$addClickedMessage__O = (function() {
  this.testGraphic__V()
});
ScalaJS.c.Ltutorial_webapp_GriEsrApp$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
ScalaJS.c.Ltutorial_webapp_GriEsrApp$.prototype.appendPar__Lorg_scalajs_dom_raw_Node__T__V = (function(targetNode, text) {
  var parNode = ScalaJS.g["document"]["createElement"]("p");
  var textNode = ScalaJS.g["document"]["createTextNode"](text);
  parNode["appendChild"](textNode);
  targetNode["appendChild"](parNode)
});
ScalaJS.c.Ltutorial_webapp_GriEsrApp$.prototype.testGraphic__V = (function() {
  var panelHistogr = new ScalaJS.c.Lcom_grisoft_scala_histogram_panel_PanelHistogr().init___Lorg_scalajs_dom_raw_HTMLCanvasElement(this.canvas$1);
  var griHistogram = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram().init___sci_List(this.getTestData__sci_List());
  var griHistogram1 = new ScalaJS.c.Lcom_grisoft_scala_histogram_model_GriHistogram().init___sci_List(this.getTestData1__sci_List());
  panelHistogr.histogramFields$1.setOneGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V(griHistogram);
  panelHistogr.histogramFields$1.addGriHistogram__Lcom_grisoft_scala_histogram_model_GriHistogram__V(griHistogram1);
  panelHistogr.paint__V()
});
ScalaJS.c.Ltutorial_webapp_GriEsrApp$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
ScalaJS.c.Ltutorial_webapp_GriEsrApp$.prototype["addClickedMessage"] = (function() {
  return this.$$js$exported$meth$addClickedMessage__O()
});
ScalaJS.d.Ltutorial_webapp_GriEsrApp$ = new ScalaJS.ClassTypeData({
  Ltutorial_webapp_GriEsrApp$: 0
}, false, "tutorial.webapp.GriEsrApp$", {
  Ltutorial_webapp_GriEsrApp$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
ScalaJS.c.Ltutorial_webapp_GriEsrApp$.prototype.$classData = ScalaJS.d.Ltutorial_webapp_GriEsrApp$;
ScalaJS.n.Ltutorial_webapp_GriEsrApp$ = (void 0);
ScalaJS.m.Ltutorial_webapp_GriEsrApp$ = (function() {
  if ((!ScalaJS.n.Ltutorial_webapp_GriEsrApp$)) {
    ScalaJS.n.Ltutorial_webapp_GriEsrApp$ = new ScalaJS.c.Ltutorial_webapp_GriEsrApp$().init___()
  };
  return ScalaJS.n.Ltutorial_webapp_GriEsrApp$
});
ScalaJS.e["tutorial"] = (ScalaJS.e["tutorial"] || {});
ScalaJS.e["tutorial"]["webapp"] = (ScalaJS.e["tutorial"]["webapp"] || {});
ScalaJS.e["tutorial"]["webapp"]["GriEsrApp"] = ScalaJS.m.Ltutorial_webapp_GriEsrApp$;
/** @constructor */
...
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.main__V = (function() {
  this.appendPar__Lorg_scalajs_dom_raw_Node__T__V(ScalaJS.g["document"]["body"], "Gri------------")
});
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.addClickedMessage__V = (function() {
  this.appendPar__Lorg_scalajs_dom_raw_Node__T__V(ScalaJS.g["document"]["body"], "You clicked the button!")
});
...
ScalaJS.c.Ltutorial_webapp_TutorialApp$.prototype.appendPar__Lorg_scalajs_dom_raw_Node__T__V = (function(targetNode, text) {
  var parNode = ScalaJS.g["document"]["createElement"]("p");
  var textNode = ScalaJS.g["document"]["createTextNode"](text);
  parNode["appendChild"](textNode);
  targetNode["appendChild"](parNode)
...
ScalaJS.e["GriTutorial"] = ScalaJS.m.Ltutorial_webapp_TutorialApp$;
ScalaJS.e["tutorial"] = (ScalaJS.e["tutorial"] || {});
ScalaJS.e["tutorial"]["webapp"] = (ScalaJS.e["tutorial"]["webapp"] || {});
...
/** @constructor */
ScalaJS.c.sr_DoubleRef = (function() {
  ScalaJS.c.O.call(this);
  this.elem$1 = 0.0
});
ScalaJS.c.sr_DoubleRef.prototype = new ScalaJS.h.O();
ScalaJS.c.sr_DoubleRef.prototype.constructor = ScalaJS.c.sr_DoubleRef;
/** @constructor */
ScalaJS.h.sr_DoubleRef = (function() {
  /*<skip>*/
});
ScalaJS.h.sr_DoubleRef.prototype = ScalaJS.c.sr_DoubleRef.prototype;
ScalaJS.c.sr_DoubleRef.prototype.init___D = (function(elem) {
  this.elem$1 = elem;
  return this
});
ScalaJS.c.sr_DoubleRef.prototype.toString__T = (function() {
  var value = this.elem$1;
  return ("" + value)
});
ScalaJS.d.sr_DoubleRef = new ScalaJS.ClassTypeData({
  sr_DoubleRef: 0
...
ScalaJS.c.sr_DoubleRef.prototype.$classData = ScalaJS.d.sr_DoubleRef;
/** @constructor */
...
ScalaJS.c.s_Double$.prototype = new ScalaJS.h.O();
ScalaJS.c.s_Double$.prototype.constructor = ScalaJS.c.s_Double$;
/** @constructor */
ScalaJS.h.s_Double$ = (function() {
  /*<skip>*/
});
ScalaJS.h.s_Double$.prototype = ScalaJS.c.s_Double$.prototype;
ScalaJS.c.s_Double$.prototype.init___ = (function() {
  ScalaJS.n.s_Double$ = this;
  this.MinValue$1 = (-1.7976931348623157E308);
  return this
});
ScalaJS.c.s_Double$.prototype.toString__T = (function() {
  return "object scala.Double"
});
ScalaJS.d.s_Double$ = new ScalaJS.ClassTypeData({
  s_Double$: 0
}, false, "scala.Double$", {
  s_Double$: 1,
  O: 1,
...
ScalaJS.c.s_Double$.prototype.$classData = ScalaJS.d.s_Double$;
ScalaJS.n.s_Double$ = (void 0);
ScalaJS.m.s_Double$ = (function() {
  if ((!ScalaJS.n.s_Double$)) {
    ScalaJS.n.s_Double$ = new ScalaJS.c.s_Double$().init___()
  };
  return ScalaJS.n.s_Double$
});
/** @constructor */
...
ScalaJS.c.T5.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    ...
    return ((((ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und1$1, Tuple5$1.$$und1$1) && ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und2$1, Tuple5$1.$$und2$1)) && ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und3$1, Tuple5$1.$$und3$1)) && ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und4$1, Tuple5$1.$$und4$1)) && ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.$$und5$1, Tuple5$1.$$und5$1))
  } else {
    return false
  }
});
...
/** @constructor */
ScalaJS.c.s_Tuple2$mcID$sp = (function() {
  ScalaJS.c.T2.call(this);
  this.$$und1$mcI$sp$f = 0;
  this.$$und2$mcD$sp$f = 0.0
});
ScalaJS.c.s_Tuple2$mcID$sp.prototype = new ScalaJS.h.T2();
ScalaJS.c.s_Tuple2$mcID$sp.prototype.constructor = ScalaJS.c.s_Tuple2$mcID$sp;
/** @constructor */
ScalaJS.h.s_Tuple2$mcID$sp = (function() {
  /*<skip>*/
});
ScalaJS.h.s_Tuple2$mcID$sp.prototype = ScalaJS.c.s_Tuple2$mcID$sp.prototype;
ScalaJS.c.s_Tuple2$mcID$sp.prototype.$$und1$mcI$sp__I = (function() {
  return this.$$und1$mcI$sp$f
});
ScalaJS.c.s_Tuple2$mcID$sp.prototype.$$und2__O = (function() {
  return this.$$und2$mcD$sp$f
});
ScalaJS.c.s_Tuple2$mcID$sp.prototype.$$und2$mcD$sp__D = (function() {
  return this.$$und2$mcD$sp$f
});
ScalaJS.c.s_Tuple2$mcID$sp.prototype.$$und1__O = (function() {
  return this.$$und1$mcI$sp$f
});
ScalaJS.c.s_Tuple2$mcID$sp.prototype.init___I__D = (function(_1$mcI$sp, _2$mcD$sp) {
  this.$$und1$mcI$sp$f = _1$mcI$sp;
  this.$$und2$mcD$sp$f = _2$mcD$sp;
  ScalaJS.c.T2.prototype.init___O__O.call(this, null, null);
  return this
});
ScalaJS.d.s_Tuple2$mcID$sp = new ScalaJS.ClassTypeData({
  s_Tuple2$mcID$sp: 0
...
ScalaJS.c.s_Tuple2$mcID$sp.prototype.$classData = ScalaJS.d.s_Tuple2$mcID$sp;
/** @constructor */
